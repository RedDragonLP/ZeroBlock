...
public class PacketBuffer extends ByteBuf {
   ...
   public PacketBuffer func_186875_a(int[] p_186875_1_) {
      ...
      for(int i = 0; i < p_186875_1_.length; ++i) {
         this.func_150787_b(p_186875_1_[i]);
      }
   ...
   public int[] func_186863_b() {
      int[] aint = new int[this.func_150792_a()];

      for(int i = 0; i < aint.length; ++i) {
         aint[i] = this.func_150792_a();
      }
   ...
   public PacketBuffer func_150786_a(NBTTagCompound p_150786_1_) {
      if(p_150786_1_ == null) {
         this.writeByte(0);
      } else {
         try {
