   ...
   PLAY(0) {
      {
         ...
         this.func_179245_a(EnumPacketDirection.CLIENTBOUND, SPacketUpdateEntityNBT.class);
         ...
         this.func_179245_a(EnumPacketDirection.CLIENTBOUND, SPacketUpdateSign.class);
         ...
         this.func_179245_a(EnumPacketDirection.SERVERBOUND, CPacketPlayer.C04PacketPlayerPosition.class);
         this.func_179245_a(EnumPacketDirection.SERVERBOUND, CPacketPlayer.C06PacketPlayerPosLook.class);
         this.func_179245_a(EnumPacketDirection.SERVERBOUND, CPacketPlayer.C05PacketPlayerLook.class);
         ...
         this.func_179245_a(EnumPacketDirection.SERVERBOUND, CPacketPlayerBlockPlacement.class);
      }
   },
   STATUS(1) {
      {
