...
public class SPacketPlayerListItem implements Packet<INetHandlerPlayClient> {
   ...
   public void func_148837_a(PacketBuffer p_148837_1_) throws IOException {
      ...
      for(int j = 0; j < i; ++j) {
         ...
         this.field_179769_b.add(new SPacketPlayerListItem.AddPlayerData(gameprofile, k, worldsettings$gametype, itextcomponent));
      }
   ...
   public class AddPlayerData {
      ...
      public AddPlayerData(GameProfile p_i46663_2_, int p_i46663_3_, WorldSettings.GameType p_i46663_4_, @Nullable ITextComponent p_i46663_5_) {
