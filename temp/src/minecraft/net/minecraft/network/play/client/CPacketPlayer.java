...
public class CPacketPlayer implements Packet<INetHandlerPlayServer> {
   ...
   public static class C04PacketPlayerPosition extends CPacketPlayer {
      ...
      public C04PacketPlayerPosition(double p_i46867_1_, double p_i46867_3_, double p_i46867_5_, boolean p_i46867_7_) {
   ...
   public static class C05PacketPlayerLook extends CPacketPlayer {
      ...
      public C05PacketPlayerLook(float p_i46863_1_, float p_i46863_2_, boolean p_i46863_3_) {
   ...
   public static class C06PacketPlayerPosLook extends CPacketPlayer {
      ...
      public C06PacketPlayerPosLook(double p_i46865_1_, double p_i46865_3_, double p_i46865_5_, float p_i46865_7_, float p_i46865_8_, boolean p_i46865_9_) {
