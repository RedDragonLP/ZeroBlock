...
public abstract class EntityLiving extends EntityLivingBase {
   ...
   public EntityLiving(World p_i1595_1_) {
      ...
      for(int i = 0; i < this.field_184655_bs.length; ++i) {
         this.field_184655_bs[i] = 0.085F;
      }

      for(int j = 0; j < this.field_82174_bp.length; ++j) {
         this.field_82174_bp[j] = 0.085F;
      }
   ...
   public void func_70071_h_() {
      ...
      if(!this.field_70170_p.field_72995_K) {
         ...
         if(this.field_70173_aa % 5 == 0) {
            ...
            this.field_70714_bg.func_188527_a(5, flag && flag1);
   ...
   public void func_70014_b(NBTTagCompound p_70014_1_) {
      ...
      for(int i = 0; i < this.field_184657_bw.length; ++i) {
         ...
         if(this.field_184657_bw[i] != null) {
            this.field_184657_bw[i].func_77955_b(nbttagcompound);
         }
      ...
      for(int k = 0; k < this.field_184656_bv.length; ++k) {
         ...
         if(this.field_184656_bv[k] != null) {
            this.field_184656_bv[k].func_77955_b(nbttagcompound1);
         }
      ...
      for(int l = 0; l < this.field_184655_bs.length; ++l) {
         nbttaglist2.func_74742_a(new NBTTagFloat(this.field_184655_bs[l]));
      }
      ...
      for(int j = 0; j < this.field_82174_bp.length; ++j) {
         nbttaglist3.func_74742_a(new NBTTagFloat(this.field_82174_bp[j]));
      }
