...
public class EntityBoat extends Entity {
   ...
   protected void func_70088_a() {
      ...
      for(int i = 0; i < field_184468_e.length; ++i) {
         this.field_70180_af.func_187214_a(field_184468_e[i], Boolean.valueOf(false));
      }
         ...
         for(int k1 = k; k1 < l; ++k1) {
            ...
            while(true) {
               ...
               for(int i2 = i1; i2 < j1; ++i2) {
                  blockpos$pooledmutableblockpos.func_185343_d(l1, k1, i2);
            ...
            for(int i2 = i1; i2 < j1; ++i2) {
               ...
               if(j2 != 2) {
                  for(int k2 = k; k2 < l; ++k2) {
                     if(j2 <= 0 || k2 != k && k2 != l - 1) {
                        blockpos$pooledmutableblockpos.func_185343_d(l1, k2, i2);
                        IBlockState iblockstate = this.field_70170_p.func_180495_p(blockpos$pooledmutableblockpos);
   ...
   private void func_184450_w() {
      ...
      if(this.field_184471_aG == EntityBoat.Status.IN_AIR && this.field_184469_aF != EntityBoat.Status.IN_AIR && this.field_184469_aF != EntityBoat.Status.ON_LAND) {
         ...
         if(d2 > 0.0D) {
            double d3 = 0.65D;
            this.field_70181_x += d2 * (-d0 / 0.65D);
            double d4 = 0.75D;
