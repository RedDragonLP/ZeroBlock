...
public abstract class EntityLivingBase extends Entity {
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      if(p_70037_1_.func_150297_b("Team", 8)) {
         ...
         this.field_70170_p.func_96441_U().func_151392_a(this.func_110124_au().toString(), s);
      }
   ...
   protected float func_70655_b(DamageSource p_70655_1_, float p_70655_2_) {
      if(!p_70655_1_.func_76363_c()) {
         ...
         p_70655_2_ = CombatRules.func_188402_a(p_70655_2_, (float)this.func_70658_aO());
      }
         ...
         if(!this.func_70090_H() || this instanceof EntityPlayer && ((EntityPlayer)this).field_71075_bZ.field_75100_b) {
            if(!this.func_180799_ab() || this instanceof EntityPlayer && ((EntityPlayer)this).field_71075_bZ.field_75100_b) {
               if(this.func_184613_cA()) {
                  ...
                  f6 = 0.91F;
                  if(this.field_70122_E) {
                     f6 = this.field_70170_p.func_180495_p(blockpos$pooledmutableblockpos.func_185338_d(this.field_70165_t, this.func_174813_aQ().field_72338_b - 1.0D, this.field_70161_v)).func_177230_c().field_149765_K * 0.91F;
                  }

                  if(this.func_70617_f_()) {
                     float f9 = 0.15F;
                     this.field_70159_w = MathHelper.func_151237_a(this.field_70159_w, (double)(-f9), (double)f9);
                     this.field_70179_y = MathHelper.func_151237_a(this.field_70179_y, (double)(-f9), (double)f9);
                  ...
                  if(this.func_70644_a(MobEffects.field_188424_y)) {
                     ...
                     blockpos$pooledmutableblockpos.func_185338_d(this.field_70165_t, 0.0D, this.field_70161_v);
