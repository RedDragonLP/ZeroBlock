...
public class EntityRabbit extends EntityAnimal {
   ...
   private int func_184772_dk() {
      BiomeGenBase biomegenbase = this.field_70170_p.func_180494_b(new BlockPos(this));
      int i = this.field_70146_Z.nextInt(100);
      return biomegenbase.func_150559_j()?(i < 80?1:3):(biomegenbase instanceof BiomeGenDesert?4:(i < 50?0:(i < 90?5:2)));
   }
