...
public class EntityChicken extends EntityAnimal {
   ...
   public void func_184232_k(Entity p_184232_1_) {
      ...
      float f2 = 0.1F;
      float f3 = 0.0F;
      p_184232_1_.func_70107_b(this.field_70165_t + (double)(f2 * f), this.field_70163_u + (double)(this.field_70131_O * 0.5F) + p_184232_1_.func_70033_W() + (double)f3, this.field_70161_v - (double)(f2 * f1));
