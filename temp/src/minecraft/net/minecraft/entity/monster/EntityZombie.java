...
public class EntityZombie extends EntityMob {
   ...
   public void func_184732_df() {
      this.func_184212_Q().func_187227_b(field_184738_bw, Integer.valueOf(0));
   }
   ...
   protected SoundEvent func_184639_G() {
      return this.func_82231_m()?SoundEvents.field_187940_hn:SoundEvents.field_187899_gZ;
   }

   protected SoundEvent func_184601_bQ() {
      return this.func_82231_m()?SoundEvents.field_187944_hr:SoundEvents.field_187934_hh;
   }

   protected SoundEvent func_184615_bR() {
      return this.func_82231_m()?SoundEvents.field_187943_hq:SoundEvents.field_187930_hd;
   }

   protected void func_180429_a(BlockPos p_180429_1_, Block p_180429_2_) {
      this.func_184185_a(this.func_82231_m()?SoundEvents.field_187946_ht:SoundEvents.field_187939_hm, 0.15F, 1.0F);
   }
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      if(p_70037_1_.func_74767_n("IsVillager")) {
         if(p_70037_1_.func_150297_b("VillagerProfession", 99)) {
            this.func_184735_a(p_70037_1_.func_74762_e("VillagerProfession"));
         } else {
