...
public class EntityShulker extends EntityGolem implements IMob {
   ...
   public void func_70071_h_() {
      ...
      if(blockpos != null) {
         ...
         this.field_70142_S = this.field_70169_q = this.field_70165_t = (double)blockpos.func_177958_n() + 0.5D;
         this.field_70137_T = this.field_70167_r = this.field_70163_u = (double)blockpos.func_177956_o();
         this.field_70136_U = this.field_70166_s = this.field_70161_v = (double)blockpos.func_177952_p() + 0.5D;
