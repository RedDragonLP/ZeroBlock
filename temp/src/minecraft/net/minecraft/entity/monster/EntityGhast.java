      ...
      public void func_75246_d() {
         ...
         if(entitylivingbase.func_70068_e(this.field_179470_b) < d0 * d0 && this.field_179470_b.func_70685_l(entitylivingbase)) {
            ...
            if(this.field_179471_a == 20) {
               ...
               double d2 = entitylivingbase.field_70165_t - (this.field_179470_b.field_70165_t + vec3d.field_72450_a * d1);
               ...
               double d4 = entitylivingbase.field_70161_v - (this.field_179470_b.field_70161_v + vec3d.field_72449_c * d1);
               ...
               entitylargefireball.field_70165_t = this.field_179470_b.field_70165_t + vec3d.field_72450_a * d1;
               entitylargefireball.field_70163_u = this.field_179470_b.field_70163_u + (double)(this.field_179470_b.field_70131_O / 2.0F) + 0.5D;
               entitylargefireball.field_70161_v = this.field_179470_b.field_70161_v + vec3d.field_72449_c * d1;
   ...
   static class AILookAround extends EntityAIBase {
      ...
      public void func_75246_d() {
         if(this.field_179472_a.func_70638_az() == null) {
            this.field_179472_a.field_70761_aq = this.field_179472_a.field_70177_z = -((float)MathHelper.func_181159_b(this.field_179472_a.field_70159_w, this.field_179472_a.field_70179_y)) * 57.295776F;
         } else {
            ...
            if(entitylivingbase.func_70068_e(this.field_179472_a) < d0 * d0) {
               ...
               this.field_179472_a.field_70761_aq = this.field_179472_a.field_70177_z = -((float)MathHelper.func_181159_b(d1, d2)) * 57.295776F;
            }
         }
