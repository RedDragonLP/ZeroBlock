         ...
         if(this.field_179478_e == 0) {
            ...
            for(int i = 0; i < inventorybasic.func_70302_i_(); ++i) {
               ...
               if(itemstack1 != null) {
                  ...
                  entityitem.field_70159_w = (double)(-MathHelper.func_76126_a(f1 * 0.017453292F) * MathHelper.func_76134_b(f2 * 0.017453292F) * f);
                  entityitem.field_70179_y = (double)(MathHelper.func_76134_b(f1 * 0.017453292F) * MathHelper.func_76134_b(f2 * 0.017453292F) * f);
                  entityitem.field_70181_x = (double)(-MathHelper.func_76126_a(f2 * 0.017453292F) * f + 0.1F);
