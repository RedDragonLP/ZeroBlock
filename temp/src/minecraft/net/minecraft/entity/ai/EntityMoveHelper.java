...
public class EntityMoveHelper {
   ...
   public void func_75641_c() {
      if(this.field_188491_h == EntityMoveHelper.Action.STRAFE) {
         ...
         if(WalkNodeProcessor.func_186330_a(this.field_75648_a.field_70170_p, MathHelper.func_76128_c(this.field_75648_a.field_70165_t + (double)f7), MathHelper.func_76128_c(this.field_75648_a.field_70163_u), MathHelper.func_76128_c(this.field_75648_a.field_70161_v + (double)f8)) != PathNodeType.WALKABLE) {
         ...
         if(d2 > (double)this.field_75648_a.field_70138_W && d0 * d0 + d1 * d1 < 1.0D) {
