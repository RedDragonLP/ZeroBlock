...
public class PhaseSittingFlaming extends PhaseSittingBase {
   ...
   public void func_188659_c() {
      ...
      if(this.field_188664_b >= 200) {
         ...
         float f = 5.0F;
         double d0 = this.field_188661_a.field_70986_h.field_70165_t + vec3d.field_72450_a * (double)f / 2.0D;
         double d1 = this.field_188661_a.field_70986_h.field_70161_v + vec3d.field_72449_c * (double)f / 2.0D;
         ...
         this.field_188666_d.func_184483_a(f);
