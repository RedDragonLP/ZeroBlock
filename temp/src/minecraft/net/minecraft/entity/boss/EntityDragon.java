...
public class EntityDragon extends EntityLiving implements IEntityMultiPart, IMob {
   ...
   public EntityDragonPart field_184673_bv;
   ...
   public void func_70636_d() {
      ...
      if(this.func_110143_aJ() <= 0.0F) {
         ...
         if(this.func_175446_cd()) {
            ...
            this.field_70986_h.field_70130_N = this.field_70986_h.field_70131_O = 1.0F;
            this.field_184673_bv.field_70130_N = this.field_184673_bv.field_70131_O = 3.0F;
            ...
            for(int j = 0; j < 3; ++j) {
               ...
               entitydragonpart.func_70012_b(this.field_70165_t - (double)((f19 * f23 + f22 * f24) * f16), this.field_70163_u + (adouble1[1] - adouble[1]) - (double)((f24 + f23) * f18) + 1.5D, this.field_70161_v + (double)((f3 * f23 + f7 * f24) * f16), 0.0F, 0.0F);
            }
   ...
   public int func_184671_o() {
      if(this.field_184680_bM[0] == null) {
         ...
         for(int i1 = 0; i1 < 24; ++i1) {
            int j1 = 5;
            if(i1 < 12) {
               i = (int)(60.0F * MathHelper.func_76134_b(2.0F * (-3.1415927F + 0.2617994F * (float)i1)));
               k = (int)(60.0F * MathHelper.func_76126_a(2.0F * (-3.1415927F + 0.2617994F * (float)i1)));
            } else if(i1 < 20) {
               l = i1 - 12;
               i = (int)(40.0F * MathHelper.func_76134_b(2.0F * (-3.1415927F + 0.3926991F * (float)l)));
               k = (int)(40.0F * MathHelper.func_76126_a(2.0F * (-3.1415927F + 0.3926991F * (float)l)));
               j1 += 10;
            } else {
               l = i1 - 20;
               i = (int)(20.0F * MathHelper.func_76134_b(2.0F * (-3.1415927F + 0.7853982F * (float)l)));
               k = (int)(20.0F * MathHelper.func_76126_a(2.0F * (-3.1415927F + 0.7853982F * (float)l)));
            }
