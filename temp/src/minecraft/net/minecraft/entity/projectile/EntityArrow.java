...
public abstract class EntityArrow extends Entity implements IProjectile {
   ...
   public void func_70186_c(double p_70186_1_, double p_70186_3_, double p_70186_5_, float p_70186_7_, float p_70186_8_) {
      ...
      this.field_70126_B = this.field_70177_z = (float)(MathHelper.func_181159_b(p_70186_1_, p_70186_5_) * 57.2957763671875D);
      this.field_70127_C = this.field_70125_A = (float)(MathHelper.func_181159_b(p_70186_3_, (double)f1) * 57.2957763671875D);
   ...
   public void func_70016_h(double p_70016_1_, double p_70016_3_, double p_70016_5_) {
      ...
      if(this.field_70127_C == 0.0F && this.field_70126_B == 0.0F) {
         ...
         this.field_70126_B = this.field_70177_z = (float)(MathHelper.func_181159_b(p_70016_1_, p_70016_5_) * 57.2957763671875D);
         this.field_70127_C = this.field_70125_A = (float)(MathHelper.func_181159_b(p_70016_3_, (double)f) * 57.2957763671875D);
   ...
   public void func_70071_h_() {
      ...
      if(this.field_70127_C == 0.0F && this.field_70126_B == 0.0F) {
         ...
         this.field_70126_B = this.field_70177_z = (float)(MathHelper.func_181159_b(this.field_70159_w, this.field_70179_y) * 57.2957763671875D);
         this.field_70127_C = this.field_70125_A = (float)(MathHelper.func_181159_b(this.field_70181_x, (double)f) * 57.2957763671875D);
      }
