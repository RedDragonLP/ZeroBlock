...
public class EntityTrackerEntry {
   ...
   private Set<EntityPlayerMP> field_73134_o = Sets.<EntityPlayerMP>newHashSet();
   ...
   public void func_73122_a(List<EntityPlayer> p_73122_1_) {
      ...
      if(this.field_73136_m % this.field_73131_c == 0 || this.field_73132_a.field_70160_al || this.field_73132_a.func_184212_Q().func_187223_a()) {
         if(!this.field_73132_a.func_184218_aH()) {
            ++this.field_73142_u;
            long j1 = EntityTracker.func_187253_a(this.field_73132_a.field_70165_t);
            ...
            int i1 = MathHelper.func_76141_d(this.field_73132_a.field_70177_z * 256.0F / 360.0F);
            int l1 = MathHelper.func_76141_d(this.field_73132_a.field_70125_A * 256.0F / 360.0F);
            boolean flag3 = Math.abs(i1 - this.field_73127_g) >= 1 || Math.abs(l1 - this.field_73139_h) >= 1;
            if(flag3) {
               this.func_151259_a(new SPacketEntity.S16PacketEntityLook(this.field_73132_a.func_145782_y(), (byte)i1, (byte)l1, this.field_73132_a.field_70122_E));
               this.field_73127_g = i1;
   ...
   private Packet<?> func_151260_c() {
      ...
      if(this.field_73132_a instanceof EntityItem) {
         ...
         if(entityfireball.field_70235_a != null) {
            spacketspawnobject3 = new SPacketSpawnObject(this.field_73132_a, i, ((EntityFireball)this.field_73132_a).field_70235_a.func_145782_y());
         } else {
            spacketspawnobject3 = new SPacketSpawnObject(this.field_73132_a, i, 0);
         }

         spacketspawnobject3.func_149003_d((int)(entityfireball.field_70232_b * 8000.0D));
         spacketspawnobject3.func_149000_e((int)(entityfireball.field_70233_c * 8000.0D));
         spacketspawnobject3.func_149007_f((int)(entityfireball.field_70230_d * 8000.0D));
         ...
         EntityItemFrame entityitemframe = (EntityItemFrame)this.field_73132_a;
         SPacketSpawnObject spacketspawnobject2 = new SPacketSpawnObject(this.field_73132_a, 71, entityitemframe.field_174860_b.func_176736_b(), entityitemframe.func_174857_n());
         ...
         SPacketSpawnObject spacketspawnobject = new SPacketSpawnObject(this.field_73132_a, 77, 0, entityleashknot.func_174857_n());
