...
public class BlockChorusFlower extends Block {
   ...
   public void func_176204_a(World p_176204_1_, BlockPos p_176204_2_, IBlockState p_176204_3_, Block p_176204_4_) {
      if(!this.func_185606_b(p_176204_1_, p_176204_2_)) {
         p_176204_1_.func_175684_a(p_176204_2_, this, 1);
      }

   }

   public boolean func_185606_b(World p_185606_1_, BlockPos p_185606_2_) {
      Block block = p_185606_1_.func_180495_p(p_185606_2_.func_177977_b()).func_177230_c();
      if(block != Blocks.field_185765_cR && block != Blocks.field_150377_bs) {
         if(block == Blocks.field_150350_a) {
            int i = 0;

            for(EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
               Block block1 = p_185606_1_.func_180495_p(p_185606_2_.func_177972_a(enumfacing)).func_177230_c();
               if(block1 == Blocks.field_185765_cR) {
                  ++i;
               } else if(block1 != Blocks.field_150350_a) {
                  return false;
               }
            }
