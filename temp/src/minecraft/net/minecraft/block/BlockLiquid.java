...
public abstract class BlockLiquid extends Block {
   ...
   protected int func_176362_e(IBlockAccess p_176362_1_, BlockPos p_176362_2_) {
      return p_176362_1_.func_180495_p(p_176362_2_).func_185904_a() == this.field_149764_J?((Integer)p_176362_1_.func_180495_p(p_176362_2_).func_177229_b(field_176367_b)).intValue():-1;
   }
   ...
   protected Vec3d func_180687_h(IBlockAccess p_180687_1_, BlockPos p_180687_2_) {
      double d0 = 0.0D;
      double d1 = 0.0D;
      double d2 = 0.0D;
      ...
      for(EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
         blockpos$pooledmutableblockpos.func_185340_h(p_180687_2_).func_185341_c(enumfacing);
         int j = this.func_176366_f(p_180687_1_, blockpos$pooledmutableblockpos);
         if(j < 0) {
            if(!p_180687_1_.func_180495_p(blockpos$pooledmutableblockpos).func_185904_a().func_76230_c()) {
               j = this.func_176366_f(p_180687_1_, blockpos$pooledmutableblockpos.func_177977_b());
               if(j >= 0) {
                  int k = j - (i - 8);
      ...
      if(((Integer)p_180687_1_.func_180495_p(p_180687_2_).func_177229_b(field_176367_b)).intValue() >= 8) {
         for(EnumFacing enumfacing1 : EnumFacing.Plane.HORIZONTAL) {
            blockpos$pooledmutableblockpos.func_185340_h(p_180687_2_).func_185341_c(enumfacing1);
            if(this.func_176212_b(p_180687_1_, blockpos$pooledmutableblockpos, enumfacing1) || this.func_176212_b(p_180687_1_, blockpos$pooledmutableblockpos.func_177984_a(), enumfacing1)) {
   ...
   public static float func_185697_a(IBlockAccess p_185697_0_, BlockPos p_185697_1_, Material p_185697_2_) {
      Vec3d vec3d = func_176361_a(p_185697_2_).func_180687_h(p_185697_0_, p_185697_1_);
