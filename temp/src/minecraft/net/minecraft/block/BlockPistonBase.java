...
public class BlockPistonBase extends BlockDirectional {
   ...
   public void func_185477_a(IBlockState p_185477_1_, World p_185477_2_, BlockPos p_185477_3_, AxisAlignedBB p_185477_4_, List<AxisAlignedBB> p_185477_5_, Entity p_185477_6_) {
   ...
   public boolean func_180648_a(World p_180648_1_, BlockPos p_180648_2_, IBlockState p_180648_3_, int p_180648_4_, int p_180648_5_) {
      EnumFacing enumfacing = (EnumFacing)p_180648_3_.func_177229_b(field_176387_N);
      ...
      if(p_180648_4_ == 0) {
         ...
         p_180648_1_.func_180501_a(p_180648_2_, p_180648_3_.func_177226_a(field_176320_b, Boolean.valueOf(true)), 2);
         p_180648_1_.func_184133_a((EntityPlayer)null, p_180648_2_, SoundEvents.field_187715_dR, SoundCategory.BLOCKS, 0.5F, p_180648_1_.field_73012_v.nextFloat() * 0.25F + 0.6F);
         ...
         p_180648_1_.func_175690_a(p_180648_2_, BlockPistonMoving.func_185588_a(this.func_176203_a(p_180648_5_), enumfacing, false, true));
         if(this.field_150082_a) {
            ...
            IBlockState iblockstate = p_180648_1_.func_180495_p(blockpos);
         ...
         p_180648_1_.func_184133_a((EntityPlayer)null, p_180648_2_, SoundEvents.field_187712_dQ, SoundCategory.BLOCKS, 0.5F, p_180648_1_.field_73012_v.nextFloat() * 0.15F + 0.6F);
      }
   ...
   private boolean func_176319_a(World p_176319_1_, BlockPos p_176319_2_, EnumFacing p_176319_3_, boolean p_176319_4_) {
      ...
      if(!blockpistonstructurehelper.func_177253_a()) {
         ...
         for(int l = list.size() - 1; l >= 0; --l) {
            ...
            p_176319_1_.func_180501_a(blockpos3, Blocks.field_150350_a.func_176223_P(), 4);
