   ...
   public byte func_74771_c(String p_74771_1_) {
      try {
         if(this.func_150297_b(p_74771_1_, 99)) {
            return ((NBTBase.NBTPrimitive)this.field_74784_a.get(p_74771_1_)).func_150290_f();
         }
   ...
   public short func_74765_d(String p_74765_1_) {
      try {
         if(this.func_150297_b(p_74765_1_, 99)) {
            return ((NBTBase.NBTPrimitive)this.field_74784_a.get(p_74765_1_)).func_150289_e();
         }
      } catch (ClassCastException var3) {
         ;
      }
   ...
   public int func_74762_e(String p_74762_1_) {
      try {
         if(this.func_150297_b(p_74762_1_, 99)) {
            return ((NBTBase.NBTPrimitive)this.field_74784_a.get(p_74762_1_)).func_150287_d();
         }
      } catch (ClassCastException var3) {
         ;
      }
   ...
   public long func_74763_f(String p_74763_1_) {
      try {
         if(this.func_150297_b(p_74763_1_, 99)) {
            return ((NBTBase.NBTPrimitive)this.field_74784_a.get(p_74763_1_)).func_150291_c();
         }
      } catch (ClassCastException var3) {
         ;
      }
   ...
   public float func_74760_g(String p_74760_1_) {
      try {
         if(this.func_150297_b(p_74760_1_, 99)) {
            return ((NBTBase.NBTPrimitive)this.field_74784_a.get(p_74760_1_)).func_150288_h();
         }
      } catch (ClassCastException var3) {
         ;
      }
   ...
   public double func_74769_h(String p_74769_1_) {
      try {
         if(this.func_150297_b(p_74769_1_, 99)) {
            return ((NBTBase.NBTPrimitive)this.field_74784_a.get(p_74769_1_)).func_150286_g();
         }
      } catch (ClassCastException var3) {
         ;
      }
