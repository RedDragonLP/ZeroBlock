...
public class WorldServer extends World implements IThreadListener {
            ...
            if(flag && flag1 && this.field_73012_v.nextInt(100000) == 0) {
               ...
               if(this.func_175727_C(blockpos)) {
                  ...
                  if(this.field_73012_v.nextDouble() < (double)difficultyinstance.func_180168_b() * 0.05D) {
                     ...
                     entityhorse.func_184778_a(HorseArmorType.SKELETON);
      ...
      if(chunkproviderserver.func_73157_c()) {
         ...
         for(Chunk chunk : Lists.newArrayList(chunkproviderserver.func_152380_a())) {
            if(chunk != null && !this.field_73063_M.func_152621_a(chunk.field_76635_g, chunk.field_76647_h)) {
               chunkproviderserver.func_73241_b(chunk.field_76635_g, chunk.field_76647_h);
            }
         }
   ...
   private boolean func_184165_i(Entity p_184165_1_) {
      if(p_184165_1_.field_70128_L) {
         field_147491_a.warn("Tried to add entity " + EntityList.func_75621_b(p_184165_1_) + " but it was marked as removed already");
         return false;
      } else {
         ...
         if(this.field_175741_N.containsKey(uuid)) {
            ...
            if(this.field_72997_g.contains(entity)) {
               ...
               if(!(p_184165_1_ instanceof EntityPlayer)) {
                  field_147491_a.warn("Keeping entity " + EntityList.func_75621_b(entity) + " that already exists with UUID " + uuid.toString());
                  return false;
               }
   ...
   public PlayerManager func_184164_w() {
