...
public class Chunk {
   ...
   public BiomeGenBase func_177411_a(BlockPos p_177411_1_, BiomeProvider p_177411_2_) {
      ...
      if(k == 255) {
         BiomeGenBase biomegenbase = p_177411_2_.func_180300_a(p_177411_1_, Biomes.field_76772_c);
         k = BiomeGenBase.func_185362_a(biomegenbase);
         this.field_76651_r[j << 4 | i] = (byte)(k & 255);
      }

      BiomeGenBase biomegenbase1 = BiomeGenBase.func_150568_d(k);
      return biomegenbase1 == null?Biomes.field_76772_c:biomegenbase1;
   }
