...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO {
   ...
   private Map<ChunkPos, NBTTagCompound> field_75828_a = new ConcurrentHashMap();
   private Set<ChunkPos> field_75826_b = Collections.<ChunkPos>newSetFromMap(new ConcurrentHashMap());
