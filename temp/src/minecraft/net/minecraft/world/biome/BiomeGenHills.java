...
public class BiomeGenHills extends BiomeGenBase {
   ...
   protected BiomeGenHills(BiomeGenHills.Type p_i46710_1_, BiomeGenBase.BiomeProperties p_i46710_2_) {
      super(p_i46710_2_);
   ...
   public void func_180622_a(World p_180622_1_, Random p_180622_2_, ChunkPrimer p_180622_3_, int p_180622_4_, int p_180622_5_, double p_180622_6_) {
      ...
      if((p_180622_6_ < -1.0D || p_180622_6_ > 2.0D) && this.field_150638_aH == BiomeGenHills.Type.MUTATED) {
         this.field_76752_A = Blocks.field_150351_n.func_176223_P();
         this.field_76753_B = Blocks.field_150351_n.func_176223_P();
      } else if(p_180622_6_ > 1.0D && this.field_150638_aH != BiomeGenHills.Type.EXTRA_TREES) {
