...
public class BiomeGenMesa extends BiomeGenBase {
   ...
   public BiomeGenMesa(boolean p_i46704_1_, boolean p_i46704_2_, BiomeGenBase.BiomeProperties p_i46704_3_) {
      super(p_i46704_3_);
   ...
   public void func_180622_a(World p_180622_1_, Random p_180622_2_, ChunkPrimer p_180622_3_, int p_180622_4_, int p_180622_5_, double p_180622_6_) {
      ...
      for(int i1 = 255; i1 >= 0; --i1) {
         if(p_180622_3_.func_177856_a(k1, i1, j1).func_185904_a() == Material.field_151579_a && i1 < (int)d4) {
            p_180622_3_.func_177855_a(k1, i1, j1, field_185365_a);
         }

         if(i1 <= p_180622_2_.nextInt(5)) {
            p_180622_3_.func_177855_a(k1, i1, j1, field_185367_c);
         } else {
            ...
            if(iblockstate1.func_185904_a() == Material.field_151579_a) {
               ...
               if(l == -1) {
                  ...
                  if(i1 < l1 && (iblockstate == null || iblockstate.func_185904_a() == Material.field_151579_a)) {
                  ...
                  if(i1 < l1 - 1) {
                     ...
                     if(iblockstate3.func_177230_c() == Blocks.field_150406_ce) {
                        p_180622_3_.func_177855_a(k1, i1, j1, field_185383_C);
                     }
                  } else if(this.field_150620_aI && i1 > 86 + k * 2) {
                     if(flag) {
                        p_180622_3_.func_177855_a(k1, i1, j1, field_185385_y);
                     } else {
                        p_180622_3_.func_177855_a(k1, i1, j1, field_185386_z);
                     }
                  } else if(i1 <= l1 + 3 + k) {
                     ...
                     if(i1 >= 64 && i1 <= 127) {
                        if(flag) {
                           ...
                           iblockstate2 = this.func_180629_a(p_180622_4_, i1, p_180622_5_);
                        }
                     } else {
                  ...
                  if(flag1) {
                     ...
                     p_180622_3_.func_177855_a(k1, i1, j1, this.func_180629_a(p_180622_4_, i1, p_180622_5_));
                  }
               }
            }
         }
