...
public class Teleporter {
   ...
   public boolean func_180620_b(Entity p_180620_1_, float p_180620_2_) {
      ...
      if(this.field_85191_c.func_76161_b(l)) {
         Teleporter.PortalPosition teleporter$portalposition = (Teleporter.PortalPosition)this.field_85191_c.func_76164_a(l);
         d0 = 0.0D;
   ...
   public void func_85189_a(long p_85189_1_) {
      if(p_85189_1_ % 100L == 0L) {
         ...
         while(iterator.hasNext()) {
            ...
            Teleporter.PortalPosition teleporter$portalposition = (Teleporter.PortalPosition)this.field_85191_c.func_76164_a(olong.longValue());
