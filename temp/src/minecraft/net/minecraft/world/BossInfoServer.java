...
public class BossInfoServer extends BossInfo {
   ...
   public void func_186735_a(float p_186735_1_) {
      if(p_186735_1_ != this.field_186750_b) {
         ...
         this.func_186759_a(SPacketUpdateEntityNBT.Operation.UPDATE_PCT);
      }
   ...
   public void func_186745_a(BossInfo.Color p_186745_1_) {
      if(p_186745_1_ != this.field_186751_c) {
         ...
         this.func_186759_a(SPacketUpdateEntityNBT.Operation.UPDATE_STYLE);
      }
   ...
   public BossInfo func_186741_a(boolean p_186741_1_) {
      if(p_186741_1_ != this.field_186753_e) {
         ...
         this.func_186759_a(SPacketUpdateEntityNBT.Operation.UPDATE_PROPERTIES);
      }
   ...
   public void func_186739_a(ITextComponent p_186739_1_) {
      if(!Objects.equal(p_186739_1_, this.field_186749_a)) {
         ...
         this.func_186759_a(SPacketUpdateEntityNBT.Operation.UPDATE_NAME);
      }

   }

   private void func_186759_a(SPacketUpdateEntityNBT.Operation p_186759_1_) {
      if(this.field_186764_j) {
         SPacketUpdateEntityNBT spacketupdateentitynbt = new SPacketUpdateEntityNBT(p_186759_1_, this);

         for(EntityPlayerMP entityplayermp : this.field_186762_h) {
            entityplayermp.field_71135_a.func_147359_a(spacketupdateentitynbt);
         }
      }
   ...
   public void func_186760_a(EntityPlayerMP p_186760_1_) {
      if(this.field_186762_h.add(p_186760_1_) && this.field_186764_j) {
         p_186760_1_.field_71135_a.func_147359_a(new SPacketUpdateEntityNBT(SPacketUpdateEntityNBT.Operation.ADD, this));
      }
   ...
   public void func_186761_b(EntityPlayerMP p_186761_1_) {
      if(this.field_186762_h.remove(p_186761_1_) && this.field_186764_j) {
         p_186761_1_.field_71135_a.func_147359_a(new SPacketUpdateEntityNBT(SPacketUpdateEntityNBT.Operation.REMOVE, this));
      }
   ...
   public void func_186758_d(boolean p_186758_1_) {
      if(p_186758_1_ != this.field_186764_j) {
         ...
         for(EntityPlayerMP entityplayermp : this.field_186762_h) {
            entityplayermp.field_71135_a.func_147359_a(new SPacketUpdateEntityNBT(p_186758_1_?SPacketUpdateEntityNBT.Operation.ADD:SPacketUpdateEntityNBT.Operation.REMOVE, this));
         }
      }
