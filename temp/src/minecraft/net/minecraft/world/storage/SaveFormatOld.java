...
public class SaveFormatOld implements ISaveFormat {
   ...
   public List<SaveFormatComparator> func_75799_b() throws AnvilConverterException {
      ...
      for(int i = 0; i < 5; ++i) {
         ...
         if(worldinfo != null) {
            list.add(new SaveFormatComparator(worldinfo, s, "", worldinfo.func_76092_g(), false));
         }
      }
   ...
   public static WorldInfo func_186353_a(File p_186353_0_, DataFixer p_186353_1_) {
      try {
         ...
         field_151479_b.error((String)("Exception reading " + p_186353_0_), (Throwable)exception);
         return null;
      }
   }
