...
public abstract class World implements IBlockAccess {
   ...
   public List<AxisAlignedBB> func_184144_a(Entity p_184144_1_, AxisAlignedBB p_184144_2_) {
      ...
      for(int k1 = i; k1 < j; ++k1) {
         for(int l1 = i1; l1 < j1; ++l1) {
            ...
            if(i2 != 2 && this.func_175667_e(blockpos$pooledmutableblockpos.func_185343_d(k1, 64, l1))) {
               for(int j2 = k; j2 < l; ++j2) {
                  if(i2 <= 0 || j2 != k && j2 != l - 1) {
                     blockpos$pooledmutableblockpos.func_185343_d(k1, j2, l1);
                     if(p_184144_1_ != null) {
                        if(flag && flag1) {
   ...
   public boolean func_147470_e(AxisAlignedBB p_147470_1_) {
      ...
      if(this.func_175663_a(i, k, i1, j, l, j1, true)) {
         ...
         for(int k1 = i; k1 < j; ++k1) {
            for(int l1 = k; l1 < l; ++l1) {
               for(int i2 = i1; i2 < j1; ++i2) {
                  Block block = this.func_180495_p(blockpos$pooledmutableblockpos.func_185343_d(k1, l1, i2)).func_177230_c();
   ...
   public boolean func_72918_a(AxisAlignedBB p_72918_1_, Material p_72918_2_, Entity p_72918_3_) {
      ...
      if(!this.func_175663_a(i, k, i1, j, l, j1, true)) {
         ...
         for(int k1 = i; k1 < j; ++k1) {
            for(int l1 = k; l1 < l; ++l1) {
               for(int i2 = i1; i2 < j1; ++i2) {
                  blockpos$pooledmutableblockpos.func_185343_d(k1, l1, i2);
                  IBlockState iblockstate = this.func_180495_p(blockpos$pooledmutableblockpos);
                  Block block = iblockstate.func_177230_c();
         ...
         if(vec3d.func_72433_c() > 0.0D && p_72918_3_.func_96092_aw()) {
            ...
            double d1 = 0.014D;
            p_72918_3_.field_70159_w += vec3d.field_72450_a * d1;
            p_72918_3_.field_70181_x += vec3d.field_72448_b * d1;
            p_72918_3_.field_70179_y += vec3d.field_72449_c * d1;
         }
   ...
   public boolean func_72875_a(AxisAlignedBB p_72875_1_, Material p_72875_2_) {
      ...
      for(int k1 = i; k1 < j; ++k1) {
         for(int l1 = k; l1 < l; ++l1) {
            for(int i2 = i1; i2 < j1; ++i2) {
               if(this.func_180495_p(blockpos$pooledmutableblockpos.func_185343_d(k1, l1, i2)).func_185904_a() == p_72875_2_) {
                  blockpos$pooledmutableblockpos.func_185344_t();
                  return true;
               }
            }
      ...
      if(p_175638_2_ == EnumSkyBlock.SKY && this.func_175678_i(p_175638_1_)) {
         ...
         if(j >= 15) {
            ...
            for(EnumFacing enumfacing : EnumFacing.values()) {
               blockpos$pooledmutableblockpos.func_185340_h(p_175638_1_).func_185341_c(enumfacing);
