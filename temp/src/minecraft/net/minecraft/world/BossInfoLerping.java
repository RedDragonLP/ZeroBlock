...
public class BossInfoLerping extends BossInfo {
   protected float field_186766_h = 0.0F;
   protected long field_186767_i = 0L;

   public BossInfoLerping(SPacketUpdateEntityNBT p_i46605_1_) {
   ...
   public void func_186765_a(SPacketUpdateEntityNBT p_186765_1_) {
