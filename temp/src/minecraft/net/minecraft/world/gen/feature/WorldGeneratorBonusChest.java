...
public class WorldGeneratorBonusChest extends WorldGenerator {
   public boolean func_180709_b(World p_180709_1_, Random p_180709_2_, BlockPos p_180709_3_) {
      ...
      while(((iblockstate = p_180709_1_.func_180495_p(p_180709_3_)).func_185904_a() == Material.field_151579_a || iblockstate.func_185904_a() == Material.field_151584_j) && p_180709_3_.func_177956_o() > 1) {
         ...
         for(int i = 0; i < 4; ++i) {
            ...
            if(p_180709_1_.func_175623_d(blockpos) && p_180709_1_.func_180495_p(blockpos.func_177977_b()).func_185896_q()) {
               ...
               if(tileentity instanceof TileEntityChest) {
                  ((TileEntityChest)tileentity).func_184287_a(LootTableList.field_186420_b, p_180709_2_.nextLong());
               }
