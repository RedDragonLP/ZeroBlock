...
public class ChunkProviderOverworld implements IChunkGenerator {
   ...
   private BiomeGenBase[] field_185981_C;
      ...
      for(int i = 0; i < 4; ++i) {
         ...
         for(int l = 0; l < 4; ++l) {
            ...
            for(int i2 = 0; i2 < 32; ++i2) {
               ...
               double d5 = (this.field_185998_q[i1 + i2 + 1] - d1) * d0;
               double d6 = (this.field_185998_q[j1 + i2 + 1] - d2) * d0;
               double d7 = (this.field_185998_q[k1 + i2 + 1] - d3) * d0;
               double d8 = (this.field_185998_q[l1 + i2 + 1] - d4) * d0;
   ...
   public void func_185977_a(int p_185977_1_, int p_185977_2_, ChunkPrimer p_185977_3_, BiomeGenBase[] p_185977_4_) {
      ...
      for(int i = 0; i < 16; ++i) {
         for(int j = 0; j < 16; ++j) {
            ...
            biomegenbase.func_180622_a(this.field_185995_n, this.field_185990_i, p_185977_3_, p_185977_1_ * 16 + i, p_185977_2_ * 16 + j, this.field_186002_u[j + i * 16]);
         }
      }
   ...
   public Chunk func_185932_a(int p_185932_1_, int p_185932_2_) {
      ...
      for(int i = 0; i < abyte.length; ++i) {
         abyte[i] = (byte)BiomeGenBase.func_185362_a(this.field_185981_C[i]);
      }
   ...
   private void func_185978_a(int p_185978_1_, int p_185978_2_, int p_185978_3_) {
      ...
      for(int k = 0; k < 5; ++k) {
         for(int l = 0; l < 5; ++l) {
            ...
            float f4 = 0.0F;
            int i1 = 2;
            BiomeGenBase biomegenbase = this.field_185981_C[k + 2 + (l + 2) * 10];

            for(int j1 = -i1; j1 <= i1; ++j1) {
               for(int k1 = -i1; k1 <= i1; ++k1) {
                  BiomeGenBase biomegenbase1 = this.field_185981_C[k + j1 + 2 + (l + k1 + 2) * 10];
                  float f5 = this.field_186000_s.field_177813_n + biomegenbase1.func_185355_j() * this.field_186000_s.field_177819_m;
                  float f6 = this.field_186000_s.field_177843_p + biomegenbase1.func_185360_m() * this.field_186000_s.field_177815_o;
   ...
   public void func_185931_b(int p_185931_1_, int p_185931_2_) {
      ...
      BiomeGenBase biomegenbase = this.field_185995_n.func_180494_b(blockpos.func_177982_a(16, 0, 16));
      ...
      if(biomegenbase != Biomes.field_76769_d && biomegenbase != Biomes.field_76786_s && this.field_186000_s.field_177781_A && !flag && this.field_185990_i.nextInt(this.field_186000_s.field_177782_B) == 0) {
      ...
      biomegenbase.func_180624_a(this.field_185995_n, this.field_185990_i, new BlockPos(i, 0, j));
      WorldEntitySpawner.func_77191_a(this.field_185995_n, biomegenbase, i + 8, j + 8, 16, 16, this.field_185990_i);
   ...
   public boolean func_185933_a(Chunk p_185933_1_, int p_185933_2_, int p_185933_3_) {
      ...
      if(this.field_186000_s.field_177852_y && this.field_185996_o && p_185933_1_.func_177416_w() < 3600L) {
         flag |= this.field_185980_B.func_175794_a(this.field_185995_n, this.field_185990_i, new ChunkCoordIntPair(p_185933_2_, p_185933_3_));
      }
   ...
   public List<BiomeGenBase.SpawnListEntry> func_177458_a(EnumCreatureType p_177458_1_, BlockPos p_177458_2_) {
      BiomeGenBase biomegenbase = this.field_185995_n.func_180494_b(p_177458_2_);
      if(this.field_185996_o) {
