...
public class ChunkProviderHell implements IChunkGenerator {
   ...
   public void func_185937_b(int p_185937_1_, int p_185937_2_, ChunkPrimer p_185937_3_) {
      ...
      double d0 = 0.03125D;
      this.field_73185_q = this.field_73177_m.func_76304_a(this.field_73185_q, p_185937_1_ * 16, p_185937_2_ * 16, 0, 16, 16, 1, d0, d0, 1.0D);
      this.field_73184_r = this.field_73177_m.func_76304_a(this.field_73184_r, p_185937_1_ * 16, 109, p_185937_2_ * 16, 16, 1, 16, d0, 1.0D, d0);
      this.field_185955_s = this.field_73174_n.func_76304_a(this.field_185955_s, p_185937_1_ * 16, p_185937_2_ * 16, 0, 16, 16, 1, d0 * 2.0D, d0 * 2.0D, d0 * 2.0D);
   ...
   public Chunk func_185932_a(int p_185932_1_, int p_185932_2_) {
      ...
      BiomeGenBase[] abiomegenbase = this.field_185952_n.func_72959_q().func_76933_b((BiomeGenBase[])null, p_185932_1_ * 16, p_185932_2_ * 16, 16, 16);
      byte[] abyte = chunk.func_76605_m();

      for(int i = 0; i < abyte.length; ++i) {
         abyte[i] = (byte)BiomeGenBase.func_185362_a(abiomegenbase[i]);
      }
   ...
   private double[] func_185938_a(double[] p_185938_1_, int p_185938_2_, int p_185938_3_, int p_185938_4_, int p_185938_5_, int p_185938_6_, int p_185938_7_) {
      ...
      this.field_185948_i = this.field_185959_w.func_76304_a(this.field_185948_i, p_185938_2_, p_185938_3_, p_185938_4_, p_185938_5_, p_185938_6_, p_185938_7_, d0 / 80.0D, d1 / 60.0D, d0 / 80.0D);
      this.field_185949_j = this.field_185957_u.func_76304_a(this.field_185949_j, p_185938_2_, p_185938_3_, p_185938_4_, p_185938_5_, p_185938_6_, p_185938_7_, d0, d1, d0);
      this.field_185950_k = this.field_185958_v.func_76304_a(this.field_185950_k, p_185938_2_, p_185938_3_, p_185938_4_, p_185938_5_, p_185938_6_, p_185938_7_, d0, d1, d0);
      int i = 0;
   ...
   public List<BiomeGenBase.SpawnListEntry> func_177458_a(EnumCreatureType p_177458_1_, BlockPos p_177458_2_) {
      ...
      BiomeGenBase biomegenbase = this.field_185952_n.func_180494_b(p_177458_2_);
