...
public class ChunkProviderDebug implements IChunkGenerator {
   ...
   public Chunk func_185932_a(int p_185932_1_, int p_185932_2_) {
      ...
      chunk.func_76603_b();
      BiomeGenBase[] abiomegenbase = this.field_177463_c.func_72959_q().func_76933_b((BiomeGenBase[])null, p_185932_1_ * 16, p_185932_2_ * 16, 16, 16);
      byte[] abyte = chunk.func_76605_m();

      for(int i1 = 0; i1 < abyte.length; ++i1) {
         abyte[i1] = (byte)BiomeGenBase.func_185362_a(abiomegenbase[i1]);
      }
