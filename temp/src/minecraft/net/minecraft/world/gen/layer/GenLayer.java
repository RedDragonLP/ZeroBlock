...
public abstract class GenLayer {
   ...
   protected static boolean func_151616_a(int p_151616_0_, int p_151616_1_) {
      if(p_151616_0_ == p_151616_1_) {
         ...
         BiomeGenBase biomegenbase = BiomeGenBase.func_150568_d(p_151616_0_);
         BiomeGenBase biomegenbase1 = BiomeGenBase.func_150568_d(p_151616_1_);
         return biomegenbase != null && biomegenbase1 != null?(biomegenbase != Biomes.field_150607_aa && biomegenbase != Biomes.field_150608_ab?biomegenbase == biomegenbase1 || biomegenbase.func_150562_l() == biomegenbase1.func_150562_l():biomegenbase1 == Biomes.field_150607_aa || biomegenbase1 == Biomes.field_150608_ab):false;
      }
   }

   protected static boolean func_151618_b(int p_151618_0_) {
      BiomeGenBase biomegenbase = BiomeGenBase.func_150568_d(p_151618_0_);
      return biomegenbase == Biomes.field_76771_b || biomegenbase == Biomes.field_150575_M || biomegenbase == Biomes.field_76776_l;
   }
