...
public class GenLayerShore extends GenLayer {
   ...
   public int[] func_75904_a(int p_75904_1_, int p_75904_2_, int p_75904_3_, int p_75904_4_) {
      ...
      for(int i = 0; i < p_75904_4_; ++i) {
         for(int j = 0; j < p_75904_3_; ++j) {
            ...
            if(k == BiomeGenBase.func_185362_a(Biomes.field_76789_p)) {
               ...
               if(j2 != BiomeGenBase.func_185362_a(Biomes.field_76771_b) && i3 != BiomeGenBase.func_185362_a(Biomes.field_76771_b) && l3 != BiomeGenBase.func_185362_a(Biomes.field_76771_b) && k4 != BiomeGenBase.func_185362_a(Biomes.field_76771_b)) {
                  aint1[j + i * p_75904_3_] = k;
               } else {
                  aint1[j + i * p_75904_3_] = BiomeGenBase.func_185362_a(Biomes.field_76788_q);
               }
               ...
               if(this.func_151631_c(i2) && this.func_151631_c(l2) && this.func_151631_c(k3) && this.func_151631_c(j4)) {
                  if(!func_151618_b(i2) && !func_151618_b(l2) && !func_151618_b(k3) && !func_151618_b(j4)) {
                     ...
                     aint1[j + i * p_75904_3_] = BiomeGenBase.func_185362_a(Biomes.field_76787_r);
                  }
               } else {
                  aint1[j + i * p_75904_3_] = BiomeGenBase.func_185362_a(Biomes.field_150574_L);
               }
            } else if(k != BiomeGenBase.func_185362_a(Biomes.field_76770_e) && k != BiomeGenBase.func_185362_a(Biomes.field_150580_W) && k != BiomeGenBase.func_185362_a(Biomes.field_76783_v)) {
               if(biomegenbase != null && biomegenbase.func_150559_j()) {
                  this.func_151632_a(aint, aint1, j, i, p_75904_3_, k, BiomeGenBase.func_185362_a(Biomes.field_150577_O));
               } else if(k != BiomeGenBase.func_185362_a(Biomes.field_150589_Z) && k != BiomeGenBase.func_185362_a(Biomes.field_150607_aa)) {
                  if(k != BiomeGenBase.func_185362_a(Biomes.field_76771_b) && k != BiomeGenBase.func_185362_a(Biomes.field_150575_M) && k != BiomeGenBase.func_185362_a(Biomes.field_76781_i) && k != BiomeGenBase.func_185362_a(Biomes.field_76780_h)) {
                  ...
                  if(!func_151618_b(l) && !func_151618_b(i1) && !func_151618_b(j1) && !func_151618_b(k1)) {
                     if(this.func_151633_d(l) && this.func_151633_d(i1) && this.func_151633_d(j1) && this.func_151633_d(k1)) {
                        ...
                        aint1[j + i * p_75904_3_] = BiomeGenBase.func_185362_a(Biomes.field_76769_d);
                     }
                  } else {
                     aint1[j + i * p_75904_3_] = k;
                  }
               ...
               this.func_151632_a(aint, aint1, j, i, p_75904_3_, k, BiomeGenBase.func_185362_a(Biomes.field_150576_N));
            }
         }
      }
   ...
   private boolean func_151631_c(int p_151631_1_) {
      return BiomeGenBase.func_150568_d(p_151631_1_) != null && BiomeGenBase.func_150568_d(p_151631_1_).func_150562_l() == BiomeGenJungle.class?true:p_151631_1_ == BiomeGenBase.func_185362_a(Biomes.field_150574_L) || p_151631_1_ == BiomeGenBase.func_185362_a(Biomes.field_76782_w) || p_151631_1_ == BiomeGenBase.func_185362_a(Biomes.field_76792_x) || p_151631_1_ == BiomeGenBase.func_185362_a(Biomes.field_76767_f) || p_151631_1_ == BiomeGenBase.func_185362_a(Biomes.field_76768_g) || func_151618_b(p_151631_1_);
   }
