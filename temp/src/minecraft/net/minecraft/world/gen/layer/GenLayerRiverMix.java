...
public class GenLayerRiverMix extends GenLayer {
   ...
   public int[] func_75904_a(int p_75904_1_, int p_75904_2_, int p_75904_3_, int p_75904_4_) {
      ...
      for(int i = 0; i < p_75904_3_ * p_75904_4_; ++i) {
         if(aint[i] != BiomeGenBase.func_185362_a(Biomes.field_76771_b) && aint[i] != BiomeGenBase.func_185362_a(Biomes.field_150575_M)) {
            if(aint1[i] == BiomeGenBase.func_185362_a(Biomes.field_76781_i)) {
               if(aint[i] == BiomeGenBase.func_185362_a(Biomes.field_76774_n)) {
                  aint2[i] = BiomeGenBase.func_185362_a(Biomes.field_76777_m);
               } else if(aint[i] != BiomeGenBase.func_185362_a(Biomes.field_76789_p) && aint[i] != BiomeGenBase.func_185362_a(Biomes.field_76788_q)) {
                  aint2[i] = aint1[i] & 255;
               } else {
                  aint2[i] = BiomeGenBase.func_185362_a(Biomes.field_76788_q);
               }
            } else {
               aint2[i] = aint[i];
            }
