...
public class Template {
   ...
   public void func_186253_b(World p_186253_1_, BlockPos p_186253_2_, PlacementSettings p_186253_3_) {
      if(!this.field_186270_a.isEmpty() && this.field_186272_c.func_177958_n() >= 1 && this.field_186272_c.func_177956_o() >= 1 && this.field_186272_c.func_177952_p() >= 1) {
         ...
         for(Template.BlockInfo template$blockinfo : this.field_186270_a) {
            Block block1 = template$blockinfo.field_186243_b.func_177230_c();
            if((block == null || block != block1) && (!p_186253_3_.func_186227_h() || block1 != Blocks.field_185779_df)) {
               BlockPos blockpos = func_186266_a(p_186253_3_, template$blockinfo.field_186242_a).func_177971_a(p_186253_2_);
               if(structureboundingbox == null || structureboundingbox.func_175898_b(blockpos)) {
                  IBlockState iblockstate = template$blockinfo.field_186243_b.func_185902_a(p_186253_3_.func_186212_b());
                  IBlockState iblockstate1 = iblockstate.func_185907_a(p_186253_3_.func_186215_c());
                  if(template$blockinfo.field_186244_c != null) {
                     TileEntity tileentity = p_186253_1_.func_175625_s(blockpos);
                     if(tileentity != null) {
                        if(tileentity instanceof IInventory) {
                           ((IInventory)tileentity).func_174888_l();
                        }

                        p_186253_1_.func_180501_a(blockpos, Blocks.field_180401_cv.func_176223_P(), 4);
                     }
                  }

                  if(p_186253_1_.func_180501_a(blockpos, iblockstate1, 2) && template$blockinfo.field_186244_c != null) {
                     TileEntity tileentity2 = p_186253_1_.func_175625_s(blockpos);
                     if(tileentity2 != null) {
                        ...
                        tileentity2.func_145839_a(template$blockinfo.field_186244_c);
                     }
                  }
               }
            }
         ...
         for(Template.BlockInfo template$blockinfo1 : this.field_186270_a) {
            if(block == null || block != template$blockinfo1.field_186243_b.func_177230_c()) {
               BlockPos blockpos1 = func_186266_a(p_186253_3_, template$blockinfo1.field_186242_a).func_177971_a(p_186253_2_);
               if(structureboundingbox == null || structureboundingbox.func_175898_b(blockpos1)) {
                  p_186253_1_.func_175722_b(blockpos1, template$blockinfo1.field_186243_b.func_177230_c());
                  if(template$blockinfo1.field_186244_c != null) {
                     TileEntity tileentity1 = p_186253_1_.func_175625_s(blockpos1);
                     if(tileentity1 != null) {
         ...
         if(p_186263_5_ == null || p_186263_5_.func_175898_b(blockpos)) {
            ...
            if(entity != null) {
               if(entity instanceof EntityPainting) {
                  ...
                  entity.func_70107_b((double)blockpos.func_177958_n(), (double)blockpos.func_177956_o(), (double)blockpos.func_177952_p());
   ...
   public void func_186265_a(NBTTagCompound p_186265_1_) {
      NBTTagList nbttaglist = new NBTTagList();
      ...
      for(Template.BlockInfo template$blockinfo : this.field_186270_a) {
         ...
         nbttagcompound.func_74768_a("state", Block.func_176210_f(template$blockinfo.field_186243_b));
         if(template$blockinfo.field_186244_c != null) {
      ...
      p_186265_1_.func_74782_a("blocks", nbttaglist);
      p_186265_1_.func_74782_a("entities", nbttaglist1);
      p_186265_1_.func_74782_a("size", this.func_186267_a(new int[]{this.field_186272_c.func_177958_n(), this.field_186272_c.func_177956_o(), this.field_186272_c.func_177952_p()}));
      p_186265_1_.func_74768_a("version", 1);
      p_186265_1_.func_74778_a("author", this.field_186273_d);
   }
   ...
   public void func_186256_b(NBTTagCompound p_186256_1_) {
      ...
      NBTTagList nbttaglist1 = p_186256_1_.func_150295_c("blocks", 10);
      ...
      for(int i = 0; i < nbttaglist1.func_74745_c(); ++i) {
         ...
         int j = nbttagcompound.func_74762_e("state");
         IBlockState iblockstate = Block.func_176220_d(j);
      ...
      NBTTagList nbttaglist3 = p_186256_1_.func_150295_c("entities", 10);

      for(int k = 0; k < nbttaglist3.func_74745_c(); ++k) {
         NBTTagCompound nbttagcompound3 = nbttaglist3.func_150305_b(k);
         NBTTagList nbttaglist4 = nbttagcompound3.func_150295_c("pos", 6);
         Vec3d vec3d = new Vec3d(nbttaglist4.func_150309_d(0), nbttaglist4.func_150309_d(1), nbttaglist4.func_150309_d(2));
         NBTTagList nbttaglist5 = nbttagcompound3.func_150295_c("blockPos", 3);
         BlockPos blockpos1 = new BlockPos(nbttaglist5.func_186858_c(0), nbttaglist5.func_186858_c(1), nbttaglist5.func_186858_c(2));
