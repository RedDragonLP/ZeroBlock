      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         for(int i2 = 0; i2 < this.field_74939_a; ++i2) {
            for(int j = 0; j < this.field_74938_c; ++j) {
               int k = -5;
               this.func_175808_b(p_74875_1_, Blocks.field_150322_A.func_176223_P(), i2, k, j, p_74875_3_);
            }
         }
   ...
   public static class Igloo extends ComponentScatteredFeaturePieces.Feature {
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         if(!this.func_74935_a(p_74875_1_, p_74875_3_, -1)) {
            ...
            PlacementSettings placementsettings = new PlacementSettings(Mirror.NONE, arotation[p_74875_2_.nextInt(arotation.length)], false, Blocks.field_180401_cv, structureboundingbox);
               ...
               for(Entry<BlockPos, String> entry : map.entrySet()) {
                  if("chest".equals(entry.getValue())) {
                     ...
                     if(tileentity instanceof TileEntityChest) {
                        ((TileEntityChest)tileentity).func_184287_a(LootTableList.field_186431_m, p_74875_2_.nextLong());
                     }
                  }
               }
            } else {
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         if(!this.func_74935_a(p_74875_1_, p_74875_3_, 0)) {
            ...
            if(!this.field_74945_j) {
               this.field_74945_j = this.func_186166_a(p_74875_1_, p_74875_3_, p_74875_2_, 3, -2, 1, EnumFacing.NORTH, field_175815_j, 2);
            }
            ...
            if(!this.field_74946_k) {
               this.field_74946_k = this.func_186166_a(p_74875_1_, p_74875_3_, p_74875_2_, 9, -2, 3, EnumFacing.WEST, field_175815_j, 2);
            }
