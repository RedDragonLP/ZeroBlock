...
public abstract class StructureComponent {
      ...
      for(int i = p_175805_6_; i <= p_175805_9_; ++i) {
         for(int j = p_175805_5_; j <= p_175805_8_; ++j) {
            for(int k = p_175805_7_; k <= p_175805_10_; ++k) {
               if(p_175805_3_.nextFloat() <= p_175805_4_ && (!p_175805_13_ || this.func_175807_a(p_175805_1_, j, i, k, p_175805_2_).func_185904_a() != Material.field_151579_a)) {
   ...
   protected boolean func_186166_a(World p_186166_1_, StructureBoundingBox p_186166_2_, Random p_186166_3_, int p_186166_4_, int p_186166_5_, int p_186166_6_, EnumFacing p_186166_7_, List<WeightedRandomChestContent> p_186166_8_, int p_186166_9_) {
      BlockPos blockpos = new BlockPos(this.func_74865_a(p_186166_4_, p_186166_6_), this.func_74862_a(p_186166_5_), this.func_74873_b(p_186166_4_, p_186166_6_));
      if(p_186166_2_.func_175898_b(blockpos) && p_186166_1_.func_180495_p(blockpos).func_177230_c() != Blocks.field_150367_z) {
         this.func_175811_a(p_186166_1_, Blocks.field_150367_z.func_176223_P().func_177226_a(BlockDispenser.field_176441_a, p_186166_7_), p_186166_4_, p_186166_5_, p_186166_6_, p_186166_2_);
         TileEntity tileentity = p_186166_1_.func_175625_s(blockpos);
         if(tileentity instanceof TileEntityDispenser) {
            WeightedRandomChestContent.func_177631_a(p_186166_3_, p_186166_8_, (TileEntityDispenser)tileentity, p_186166_9_);
         }
   ...
   protected void func_175810_a(World p_175810_1_, StructureBoundingBox p_175810_2_, Random p_175810_3_, int p_175810_4_, int p_175810_5_, int p_175810_6_, EnumFacing p_175810_7_) {
      this.func_175811_a(p_175810_1_, Blocks.field_180413_ao.func_176223_P().func_177226_a(BlockDoor.field_176520_a, p_175810_7_), p_175810_4_, p_175810_5_, p_175810_6_, p_175810_2_);
      this.func_175811_a(p_175810_1_, Blocks.field_180413_ao.func_176223_P().func_177226_a(BlockDoor.field_176520_a, p_175810_7_).func_177226_a(BlockDoor.field_176523_O, BlockDoor.EnumDoorHalf.UPPER), p_175810_4_, p_175810_5_ + 1, p_175810_6_, p_175810_2_);
   }
