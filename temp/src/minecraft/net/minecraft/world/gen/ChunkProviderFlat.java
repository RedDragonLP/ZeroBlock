...
public class ChunkProviderFlat implements IChunkGenerator {
   ...
   public ChunkProviderFlat(World p_i2004_1_, long p_i2004_2_, boolean p_i2004_4_, String p_i2004_5_) {
      ...
      this.field_82697_g = flag && this.field_82699_e.func_82648_a() != BiomeGenBase.func_185362_a(Biomes.field_185440_P)?false:this.field_82699_e.func_82644_b().containsKey("decoration");
   }
   ...
   public Chunk func_185932_a(int p_185932_1_, int p_185932_2_) {
      ...
      BiomeGenBase[] abiomegenbase = this.field_73163_a.func_72959_q().func_76933_b((BiomeGenBase[])null, p_185932_1_ * 16, p_185932_2_ * 16, 16, 16);
      byte[] abyte = chunk.func_76605_m();

      for(int l = 0; l < abyte.length; ++l) {
         abyte[l] = (byte)BiomeGenBase.func_185362_a(abiomegenbase[l]);
      }
