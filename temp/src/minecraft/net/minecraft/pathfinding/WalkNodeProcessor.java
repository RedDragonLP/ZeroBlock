...
public class WalkNodeProcessor extends NodeProcessor {
   ...
   public static PathNodeType func_186330_a(IBlockAccess p_186330_0_, int p_186330_1_, int p_186330_2_, int p_186330_3_) {
      ...
      IBlockState iblockstate = p_186330_0_.func_180495_p(blockpos);
      ...
      if(block != Blocks.field_150415_aT && block != Blocks.field_180400_cw && block != Blocks.field_150392_bi) {
         if(block == Blocks.field_150480_ab) {
            ...
            if(block.func_176205_b(p_186330_0_, blockpos) && pathnodetype == PathNodeType.BLOCKED) {
               pathnodetype = PathNodeType.OPEN;
            }
               ...
               for(int j = p_186330_1_ - 1; j <= p_186330_1_ + 1; ++j) {
                  for(int i = p_186330_3_ - 1; i <= p_186330_3_ + 1; ++i) {
                     if(j != p_186330_1_ || i != p_186330_3_) {
                        Block block1 = p_186330_0_.func_180495_p(new BlockPos(j, p_186330_2_, i)).func_177230_c();
