...
public abstract class MinecraftServer implements Runnable, ICommandSender, IThreadListener, ISnooperInfo {
   ...
   public void func_71260_j() {
      ...
      if(this.field_71305_c != null) {
         ...
         for(int i = 0; i < this.field_71305_c.length; ++i) {
            if(this.field_71305_c[i] != null) {
               this.field_71305_c[i].field_73058_d = false;
            }
         }
   ...
   public void run() {
      try {
         if(this.func_71197_b()) {
            ...
            this.field_147147_p.func_151321_a(new ServerStatusResponse.Version("1.9", 107));
   ...
   public List<String> func_184104_a(ICommandSender p_184104_1_, String p_184104_2_, BlockPos p_184104_3_, boolean p_184104_4_) {
   ...
   public void func_71235_a(WorldSettings.GameType p_71235_1_) {
      for(int i = 0; i < this.field_71305_c.length; ++i) {
         this.field_71305_c[i].func_72912_H().func_76060_a(p_71235_1_);
      }
   ...
   public int func_184108_a(WorldServer p_184108_1_) {
