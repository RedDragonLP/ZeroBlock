      ...
      if(this.field_73091_c == WorldSettings.GameType.SPECTATOR) {
         ...
         if(tileentity instanceof ILockableContainer) {
            ...
            if(ilockablecontainer instanceof TileEntityChest && block instanceof BlockChest) {
               ilockablecontainer = ((BlockChest)block).func_180676_d(p_187251_2_, p_187251_5_);
            }
         ...
         if(p_187251_3_ == null) {
            ...
            return EnumActionResult.PASS;
         } else if(p_187251_3_.func_77973_b() instanceof ItemBlock && ((ItemBlock)p_187251_3_.func_77973_b()).func_179223_d() instanceof BlockCommandBlock && !p_187251_1_.func_70003_b(2, "")) {
