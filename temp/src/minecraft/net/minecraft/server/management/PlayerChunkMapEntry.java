...
public class PlayerChunkMapEntry {
   ...
   public boolean func_187272_b() {
      if(this.field_187290_j) {
         ...
         SPacketChunkData spacketchunkdata = new SPacketChunkData(this.field_187286_f, '\uffff');
   ...
   public void func_187279_c() {
      if(this.field_187286_f != null) {
         this.field_187286_f.func_177415_c(this.field_187286_f.func_177416_w() + this.field_187282_b.func_72688_a().func_82737_E() - this.field_187289_i);
      }
