...
public class NetHandlerLoginServer implements INetHandlerLoginServer, ITickable {
   ...
   public void func_147316_a(CPacketLoginStart p_147316_1_) {
      ...
      if(this.field_147327_f.func_71266_T() && !this.field_147333_a.func_150731_c()) {
         ...
         this.field_147333_a.func_179290_a(new SPacketEncryptionRequest(this.field_147334_j, this.field_147327_f.func_71250_E().getPublic(), this.field_147330_e));
      } else {
         this.field_147328_g = NetHandlerLoginServer.LoginState.READY_TO_ACCEPT;
      }
            ...
            public void run() {
               ...
               try {
                  ...
                  if(NetHandlerLoginServer.this.field_147337_i != null) {
                     ...
                     NetHandlerLoginServer.field_147332_c.error("Username \'" + gameprofile.getName() + "\' tried to join with an invalid session");
                  }
