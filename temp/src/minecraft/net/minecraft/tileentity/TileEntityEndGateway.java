...
public class TileEntityEndGateway extends TileEntity implements ITickable {
   ...
   private long field_184315_f = 0L;
   ...
   public void func_145841_b(NBTTagCompound p_145841_1_) {
      ...
      p_145841_1_.func_74772_a("Age", this.field_184315_f);
      if(this.field_184317_h != null) {
         p_145841_1_.func_74782_a("ExitPortal", NBTUtil.func_186859_a(this.field_184317_h));
      }

      if(this.field_184318_i) {
         p_145841_1_.func_74757_a("ExactTeleport", this.field_184318_i);
      }
   ...
   public Packet<?> func_145844_m() {
      ...
      return new SPacketUpdateTileEntity(this.field_174879_c, 8, nbttagcompound);
   }
   ...
   private BlockPos func_184303_j() {
      ...
      field_184314_a.debug("Best exit position for portal at " + this.field_184317_h + " is " + blockpos);
   ...
   private void func_184311_k() {
      ...
      for(int i = 16; func_184301_a(this.field_145850_b, vec3d1).func_76625_h() > 0 && i-- > 0; vec3d1 = vec3d1.func_178787_e(vec3d.func_186678_a(-16.0D))) {
         field_184314_a.debug("Skipping backwards past nonempty chunk at " + vec3d1);
      }
      ...
      for(int j = 16; func_184301_a(this.field_145850_b, vec3d1).func_76625_h() == 0 && j-- > 0; vec3d1 = vec3d1.func_178787_e(vec3d.func_186678_a(16.0D))) {
         field_184314_a.debug("Skipping forward past empty chunk at " + vec3d1);
      }

      field_184314_a.debug("Found chunk at " + vec3d1);
   ...
   private void func_184312_b(BlockPos p_184312_1_) {
      ...
      if(tileentity instanceof TileEntityEndGateway) {
         ...
         field_184314_a.warn("Couldn\'t save exit portal at " + p_184312_1_);
      }
