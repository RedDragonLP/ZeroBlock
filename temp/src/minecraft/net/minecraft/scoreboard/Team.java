...
public abstract class Team {
   ...
   public static enum CollisionRule {
      ...
      private static Map<String, Team.CollisionRule> field_186695_g = Maps.<String, Team.CollisionRule>newHashMap();
   ...
   public static enum EnumVisible {
      ...
      private static Map<String, Team.EnumVisible> field_186697_g = Maps.<String, Team.EnumVisible>newHashMap();
