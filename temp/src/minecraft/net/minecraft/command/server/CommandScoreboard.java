...
public class CommandScoreboard extends CommandBase {
   ...
   public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException {
      if(!this.func_184909_b(p_184881_1_, p_184881_2_, p_184881_3_)) {
         if(p_184881_3_.length < 1) {
            ...
            if(p_184881_3_[0].equalsIgnoreCase("objectives")) {
               if(p_184881_3_.length == 1) {
                  throw new WrongUsageException("commands.scoreboard.objectives.usage", new Object[0]);
               }

               if(p_184881_3_[1].equalsIgnoreCase("list")) {
                  this.func_184925_a(p_184881_2_, p_184881_1_);
               } else if(p_184881_3_[1].equalsIgnoreCase("add")) {
                  if(p_184881_3_.length < 4) {
                     throw new WrongUsageException("commands.scoreboard.objectives.add.usage", new Object[0]);
                  }

                  this.func_184908_a(p_184881_2_, p_184881_3_, 2, p_184881_1_);
               } else if(p_184881_3_[1].equalsIgnoreCase("remove")) {
                  ...
                  if(!p_184881_3_[1].equalsIgnoreCase("setdisplay")) {
                     throw new WrongUsageException("commands.scoreboard.objectives.usage", new Object[0]);
                  }
            ...
            } else if(p_184881_3_[0].equalsIgnoreCase("players")) {
               if(p_184881_3_.length == 1) {
               ...
               if(p_184881_3_[1].equalsIgnoreCase("list")) {
                  ...
                  this.func_184918_k(p_184881_2_, p_184881_3_, 2, p_184881_1_);
               } else if(p_184881_3_[1].equalsIgnoreCase("set")) {
                  if(p_184881_3_.length < 5) {
                     throw new WrongUsageException("commands.scoreboard.players.set.usage", new Object[0]);
                  }

                  this.func_184918_k(p_184881_2_, p_184881_3_, 2, p_184881_1_);
               } else if(p_184881_3_[1].equalsIgnoreCase("reset")) {
                  if(p_184881_3_.length != 3 && p_184881_3_.length != 4) {
                     throw new WrongUsageException("commands.scoreboard.players.reset.usage", new Object[0]);
                  }

                  this.func_184912_l(p_184881_2_, p_184881_3_, 2, p_184881_1_);
               } else if(p_184881_3_[1].equalsIgnoreCase("enable")) {
                  if(p_184881_3_.length != 4) {
               ...
               } else if(p_184881_3_[1].equalsIgnoreCase("test")) {
               ...
               } else if(p_184881_3_[1].equalsIgnoreCase("operation")) {
                  ...
                  if(!p_184881_3_[1].equalsIgnoreCase("tag")) {
                     throw new WrongUsageException("commands.scoreboard.players.usage", new Object[0]);
                  }
               ...
               if(!p_184881_3_[0].equalsIgnoreCase("teams")) {
                  throw new WrongUsageException("commands.scoreboard.usage", new Object[0]);
               }
               ...
               if(p_184881_3_[1].equalsIgnoreCase("list")) {
               ...
               } else if(p_184881_3_[1].equalsIgnoreCase("empty")) {
                  if(p_184881_3_.length != 3) {
                     throw new WrongUsageException("commands.scoreboard.teams.empty.usage", new Object[0]);
                  }

                  this.func_184917_h(p_184881_2_, p_184881_3_, 2, p_184881_1_);
               } else if(p_184881_3_[1].equalsIgnoreCase("join")) {
               ...
               } else if(p_184881_3_[1].equalsIgnoreCase("leave")) {
                  ...
                  if(!p_184881_3_[1].equalsIgnoreCase("option")) {
                     throw new WrongUsageException("commands.scoreboard.teams.usage", new Object[0]);
                  }
         ...
         while(p_184916_3_ < p_184916_2_.length) {
            ...
            if(s1.startsWith("@")) {
               for(Entity entity : func_184890_c(p_184916_4_, p_184916_1_, s1)) {
                  String s3 = func_184891_e(p_184916_4_, p_184916_1_, entity.func_110124_au().toString());
         ...
         while(p_184911_3_ < p_184911_2_.length) {
            ...
            if(s.startsWith("@")) {
               for(Entity entity : func_184890_c(p_184911_4_, p_184911_1_, s)) {
                  String s2 = func_184891_e(p_184911_4_, p_184911_1_, entity.func_110124_au().toString());
   ...
   protected void func_184918_k(ICommandSender p_184918_1_, String[] p_184918_2_, int p_184918_3_, MinecraftServer p_184918_4_) throws CommandException {
      ...
      if(s1.length() > 40) {
         ...
         int j = s.equalsIgnoreCase("set")?func_175755_a(p_184918_2_[p_184918_3_++]):func_180528_a(p_184918_2_[p_184918_3_++], 0);
   ...
   public List<String> func_184883_a(MinecraftServer p_184883_1_, ICommandSender p_184883_2_, String[] p_184883_3_, BlockPos p_184883_4_) {
      if(p_184883_3_.length == 1) {
         ...
         } else if(p_184883_3_[0].equalsIgnoreCase("players")) {
            if(p_184883_3_.length == 2) {
               return func_71530_a(p_184883_3_, new String[]{"set", "add", "remove", "reset", "list", "enable", "test", "operation", "tag"});
            }

            if(!p_184883_3_[1].equalsIgnoreCase("set") && !p_184883_3_[1].equalsIgnoreCase("add") && !p_184883_3_[1].equalsIgnoreCase("remove") && !p_184883_3_[1].equalsIgnoreCase("reset")) {
               if(p_184883_3_[1].equalsIgnoreCase("enable")) {
                  if(p_184883_3_.length == 3) {
               ...
               } else if(!p_184883_3_[1].equalsIgnoreCase("list") && !p_184883_3_[1].equalsIgnoreCase("test")) {
                  if(p_184883_3_[1].equalsIgnoreCase("operation")) {
                     if(p_184883_3_.length == 3) {
                  ...
                  } else if(p_184883_3_[1].equalsIgnoreCase("tag")) {
                     if(p_184883_3_.length == 3) {
                        return func_175762_a(p_184883_3_, this.func_184913_a(p_184883_1_).func_96526_d());
                     }
                  ...
                  if(p_184883_3_.length == 4 && p_184883_3_[1].equalsIgnoreCase("test")) {
                     return func_175762_a(p_184883_3_, this.func_184926_a(false, p_184883_1_));
                  }
               }
            } else {
         ...
         } else if(p_184883_3_[0].equalsIgnoreCase("teams")) {
            if(p_184883_3_.length == 2) {
               return func_71530_a(p_184883_3_, new String[]{"add", "remove", "join", "leave", "empty", "list", "option"});
            }

            if(p_184883_3_[1].equalsIgnoreCase("join")) {
               if(p_184883_3_.length == 3) {
               ...
               if(p_184883_3_[1].equalsIgnoreCase("leave")) {
                  return func_71530_a(p_184883_3_, p_184883_1_.func_71213_z());
               }

               if(!p_184883_3_[1].equalsIgnoreCase("empty") && !p_184883_3_[1].equalsIgnoreCase("list") && !p_184883_3_[1].equalsIgnoreCase("remove")) {
                  if(p_184883_3_[1].equalsIgnoreCase("option")) {
                     if(p_184883_3_.length == 3) {
                        return func_175762_a(p_184883_3_, this.func_184913_a(p_184883_1_).func_96531_f());
                     }
                     ...
                     if(p_184883_3_.length == 5) {
                        if(p_184883_3_[3].equalsIgnoreCase("color")) {
                           return func_175762_a(p_184883_3_, TextFormatting.func_96296_a(true, false));
                        }

                        if(p_184883_3_[3].equalsIgnoreCase("nametagVisibility") || p_184883_3_[3].equalsIgnoreCase("deathMessageVisibility")) {
                           return func_71530_a(p_184883_3_, Team.EnumVisible.func_178825_a());
                        }

                        if(p_184883_3_[3].equalsIgnoreCase("collisionRule")) {
                           return func_71530_a(p_184883_3_, Team.CollisionRule.func_186687_a());
                        }

                        if(p_184883_3_[3].equalsIgnoreCase("friendlyfire") || p_184883_3_[3].equalsIgnoreCase("seeFriendlyInvisibles")) {
