   ...
   public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException {
      if(p_184881_3_.length < 9) {
         ...
         if(i > '\u8000') {
            ...
            Block block = null;
            int j = -1;
            if((p_184881_3_.length < 11 || !p_184881_3_[10].equals("force") && !p_184881_3_[10].equals("move")) && structureboundingbox.func_78884_a(structureboundingbox1)) {
               throw new CommandException("commands.clone.noOverlap", new Object[0]);
            } else {
               if(p_184881_3_.length >= 11 && p_184881_3_[10].equals("move")) {
                  flag = true;
               }
               ...
               if(structureboundingbox.field_78895_b >= 0 && structureboundingbox.field_78894_e < 256 && structureboundingbox1.field_78895_b >= 0 && structureboundingbox1.field_78894_e < 256) {
                  ...
                  if(world.func_175711_a(structureboundingbox) && world.func_175711_a(structureboundingbox1)) {
                     ...
                     if(p_184881_3_.length >= 10) {
                        if(p_184881_3_[9].equals("masked")) {
                           flag1 = true;
                        } else if(p_184881_3_[9].equals("filtered")) {
