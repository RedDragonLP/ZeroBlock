...
public class CommandDefaultGameMode extends CommandGameMode {
   ...
   public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException {
      if(p_184881_3_.length <= 0) {
         ...
         this.func_184896_a(worldsettings$gametype, p_184881_1_);
         func_152373_a(p_184881_2_, this, "commands.defaultgamemode.success", new Object[]{new TextComponentTranslation("gameMode." + worldsettings$gametype.func_77149_b(), new Object[0])});
      }
   }
