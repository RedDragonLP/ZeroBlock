...
public class Minecraft implements IThreadListener, ISnooperInfo {
   ...
   private final DataFixer field_184131_U = DataFixesManager.func_188279_a();
   ...
   private Snooper field_71427_U = new Snooper("client", this, MinecraftServer.func_130071_aq());
   ...
   public void func_181536_a(int p_181536_1_, int p_181536_2_, int p_181536_3_, int p_181536_4_, int p_181536_5_, int p_181536_6_, int p_181536_7_, int p_181536_8_, int p_181536_9_, int p_181536_10_) {
      ...
      vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
      vertexbuffer.func_181662_b((double)p_181536_1_, (double)(p_181536_2_ + p_181536_6_), 0.0D).func_187315_a((double)((float)p_181536_3_ * f), (double)((float)(p_181536_4_ + p_181536_6_) * f1)).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
      vertexbuffer.func_181662_b((double)(p_181536_1_ + p_181536_5_), (double)(p_181536_2_ + p_181536_6_), 0.0D).func_187315_a((double)((float)(p_181536_3_ + p_181536_5_) * f), (double)((float)(p_181536_4_ + p_181536_6_) * f1)).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
      vertexbuffer.func_181662_b((double)(p_181536_1_ + p_181536_5_), (double)p_181536_2_, 0.0D).func_187315_a((double)((float)(p_181536_3_ + p_181536_5_) * f), (double)((float)p_181536_4_ * f1)).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
      vertexbuffer.func_181662_b((double)p_181536_1_, (double)p_181536_2_, 0.0D).func_187315_a((double)((float)p_181536_3_ * f), (double)((float)p_181536_4_ * f1)).func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).func_181675_d();
   ...
   private void func_71366_a(long p_71366_1_) {
      if(this.field_71424_I.field_76327_a) {
         ...
         vertexbuffer.func_181662_b((double)((float)j - (float)i * 1.1F), (double)((float)k - (float)i * 0.6F - 16.0F), 0.0D).func_181669_b(200, 0, 0, 0).func_181675_d();
         vertexbuffer.func_181662_b((double)((float)j - (float)i * 1.1F), (double)(k + i * 2), 0.0D).func_181669_b(200, 0, 0, 0).func_181675_d();
         vertexbuffer.func_181662_b((double)((float)j + (float)i * 1.1F), (double)(k + i * 2), 0.0D).func_181669_b(200, 0, 0, 0).func_181675_d();
         vertexbuffer.func_181662_b((double)((float)j + (float)i * 1.1F), (double)((float)k - (float)i * 0.6F - 16.0F), 0.0D).func_181669_b(200, 0, 0, 0).func_181675_d();
         tessellator.func_78381_a();
   ...
   private boolean func_184122_c(int p_184122_1_) {
      if(p_184122_1_ == 30) {
         ...
         boolean flag = !this.field_175616_W.func_178634_b();
         this.field_175616_W.func_178629_b(flag);
   ...
   public CrashReport func_71396_d(CrashReport p_71396_1_) {
      ...
      p_71396_1_.func_85056_g().func_71507_a("CPU", new Callable<String>() {
         public String call() {
