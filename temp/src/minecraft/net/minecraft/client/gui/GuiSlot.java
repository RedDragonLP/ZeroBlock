...
public abstract class GuiSlot {
   ...
   public void func_148128_a(int p_148128_1_, int p_148128_2_, float p_148128_3_) {
      if(this.field_178041_q) {
         ...
         vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
         vertexbuffer.func_181662_b((double)this.field_148152_e, (double)(this.field_148153_b + i1), 0.0D).func_187315_a(0.0D, 1.0D).func_181669_b(0, 0, 0, 0).func_181675_d();
         vertexbuffer.func_181662_b((double)this.field_148151_d, (double)(this.field_148153_b + i1), 0.0D).func_187315_a(1.0D, 1.0D).func_181669_b(0, 0, 0, 0).func_181675_d();
         ...
         vertexbuffer.func_181662_b((double)this.field_148151_d, (double)(this.field_148154_c - i1), 0.0D).func_187315_a(1.0D, 0.0D).func_181669_b(0, 0, 0, 0).func_181675_d();
         vertexbuffer.func_181662_b((double)this.field_148152_e, (double)(this.field_148154_c - i1), 0.0D).func_187315_a(0.0D, 0.0D).func_181669_b(0, 0, 0, 0).func_181675_d();
         tessellator.func_78381_a();
