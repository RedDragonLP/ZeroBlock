   ...
   protected void func_146284_a(GuiButton p_146284_1_) throws IOException {
      if(p_146284_1_.field_146124_l) {
         ...
         if(p_146284_1_.field_146127_k == 2 && guilistextended$iguilistentry instanceof ServerListEntryNormal) {
            ...
            this.field_146297_k.func_147108_a(new GuiScreenServerList(this, this.field_146811_z = new ServerData(I18n.func_135052_a("selectServer.defaultName", new Object[0]), "", false)));
         } else if(p_146284_1_.field_146127_k == 3) {
            this.field_146806_v = true;
            this.field_146297_k.func_147108_a(new GuiScreenAddServer(this, this.field_146811_z = new ServerData(I18n.func_135052_a("selectServer.defaultName", new Object[0]), "", false)));
