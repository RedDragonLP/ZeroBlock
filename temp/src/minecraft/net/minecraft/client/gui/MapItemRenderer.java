...
public class MapItemRenderer {
   ...
   class Instance {
      ...
      private void func_148237_a(boolean p_148237_1_) {
         ...
         vertexbuffer.func_181662_b((double)((float)(i + 0) + f), (double)((float)(j + 128) - f), -0.009999999776482582D).func_187315_a(0.0D, 1.0D).func_181675_d();
         vertexbuffer.func_181662_b((double)((float)(i + 128) - f), (double)((float)(j + 128) - f), -0.009999999776482582D).func_187315_a(1.0D, 1.0D).func_181675_d();
         vertexbuffer.func_181662_b((double)((float)(i + 128) - f), (double)((float)(j + 0) + f), -0.009999999776482582D).func_187315_a(1.0D, 0.0D).func_181675_d();
         vertexbuffer.func_181662_b((double)((float)(i + 0) + f), (double)((float)(j + 0) + f), -0.009999999776482582D).func_187315_a(0.0D, 0.0D).func_181675_d();
