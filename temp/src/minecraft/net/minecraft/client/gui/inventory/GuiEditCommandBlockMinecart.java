...
public class GuiEditCommandBlockMinecart extends GuiScreen implements ITabCompleter {
   ...
   public void func_73866_w_() {
      ...
      this.field_146292_n.add(this.field_184094_h = new GuiButton(0, this.field_146294_l / 2 - 4 - 150, this.field_146295_m / 4 + 120 + 12, 150, 20, I18n.func_135052_a("gui.done", new Object[0])));
      this.field_146292_n.add(this.field_184095_i = new GuiButton(1, this.field_146294_l / 2 + 4, this.field_146295_m / 4 + 120 + 12, 150, 20, I18n.func_135052_a("gui.cancel", new Object[0])));
      this.field_146292_n.add(this.field_184089_r = new GuiButton(4, this.field_146294_l / 2 + 150 - 20, 150, 20, 20, "O"));
