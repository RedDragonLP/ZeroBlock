...
public class GuiBeacon extends GuiContainer {
   ...
   public void func_73876_c() {
      ...
      if(this.field_147027_y && i >= 0) {
         ...
         int k1 = 3;
         int l1 = TileEntityBeacon.field_146009_a[k1].length + 1;
         int i2 = l1 * 22 + (l1 - 1) * 2;

         for(int j2 = 0; j2 < l1 - 1; ++j2) {
            Potion potion3 = TileEntityBeacon.field_146009_a[k1][j2];
            GuiBeacon.PowerButton guibeacon$powerbutton2 = new GuiBeacon.PowerButton(j++, this.field_147003_i + 167 + j2 * 24 - i2 / 2, this.field_147009_r + 47, potion3, k1);
         ...
         if(potion != null) {
            GuiBeacon.PowerButton guibeacon$powerbutton1 = new GuiBeacon.PowerButton(j++, this.field_147003_i + 167 + (l1 - 1) * 24 - i2 / 2, this.field_147009_r + 47, potion, k1);
   ...
   protected void func_146284_a(GuiButton p_146284_1_) throws IOException {
      if(p_146284_1_.field_146127_k == -2) {
         ...
         this.field_146297_k.func_147114_u().func_147297_a(new CPacketCustomPayload(s, packetbuffer));
         this.field_146297_k.field_71439_g.field_71174_a.func_147297_a(new CPacketCloseWindow(this.field_146297_k.field_71439_g.field_71070_bA.field_75152_c));
         this.field_146297_k.func_147108_a((GuiScreen)null);
