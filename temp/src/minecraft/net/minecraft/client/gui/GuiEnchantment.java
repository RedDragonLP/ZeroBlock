   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      for(int j = 0; j < 3; ++j) {
         ...
         if(this.func_146978_c(60, 14 + 19 * j, 108, 17, p_73863_1_, p_73863_2_) && k > 0 && l >= 0 && enchantment != null) {
            ...
            list.add(TextFormatting.WHITE.toString() + TextFormatting.ITALIC.toString() + I18n.func_135052_a("container.enchant.clue", new Object[]{enchantment.func_77316_c(l)}));
            if(!flag) {
               list.add("");
               if(this.field_146297_k.field_71439_g.field_71068_ca < k) {
                  list.add(TextFormatting.RED.toString() + "Level Requirement: " + this.field_147075_G.field_75167_g[j]);
               } else {
                  String s;
                  if(i1 == 1) {
