...
public class GuiWorldSelection extends GuiScreen implements GuiYesNoCallback {
   ...
   public void func_184862_a() {
      ...
      this.field_146292_n.add(this.field_146630_A = new GuiButton(4, this.field_146294_l / 2 - 154, this.field_146295_m - 28, 72, 20, I18n.func_135052_a("selectWorld.edit", new Object[0])));
      ...
      this.field_146292_n.add(this.field_184865_t = new GuiButton(5, this.field_146294_l / 2 + 4, this.field_146295_m - 28, 72, 20, I18n.func_135052_a("selectWorld.recreate", new Object[0])));
