   ...
   public void func_184068_a(ScaledResolution p_184068_1_) {
      ...
      if(this.field_184071_g && !this.field_184070_f.isEmpty()) {
         ...
         for(GuiSubtitleOverlay.Subtitle guisubtitleoverlay$subtitle1 : this.field_184070_f) {
            ...
            GlStateManager.func_179094_E();
            GlStateManager.func_179109_b((float)p_184068_1_.func_78326_a() - (float)l * f - 2.0F, (float)(p_184068_1_.func_78328_b() - 30) - (float)(i * (i1 + 1)) * f, 0.0F);
            GlStateManager.func_179152_a(f, f, f);
            func_73734_a(-l - 1, -j1 - 1, l + 1, j1 + 1, (int)((double)k * 0.8D) << 24);
            GlStateManager.func_179147_l();
            if(!flag) {
               if(d0 > 0.0D) {
                  this.field_184069_a.field_71466_p.func_78276_b(">", l - this.field_184069_a.field_71466_p.func_78256_a(">"), -j1, i2 + (k << 24 & -16777216));
               } else if(d0 < 0.0D) {
                  this.field_184069_a.field_71466_p.func_78276_b("<", -l, -j1, i2 + (k << 24 & -16777216));
               }
            }

            this.field_184069_a.field_71466_p.func_78276_b(s, -k1 / 2, -j1, i2 + (k << 24 & -16777216));
