...
public class GuiCommandBlock extends GuiScreen implements ITabCompleter {
   ...
   public void func_73866_w_() {
      ...
      this.field_146292_n.add(this.field_175390_s = new GuiButton(4, this.field_146294_l / 2 + 150 - 20, 135, 20, 20, "O"));
      this.field_146292_n.add(this.field_184079_s = new GuiButton(5, this.field_146294_l / 2 - 50 - 100 - 4, 165, 100, 20, I18n.func_135052_a("advMode.mode.sequence", new Object[0])));
      this.field_146292_n.add(this.field_184080_t = new GuiButton(6, this.field_146294_l / 2 - 50, 165, 100, 20, I18n.func_135052_a("advMode.mode.unconditional", new Object[0])));
      this.field_146292_n.add(this.field_184081_u = new GuiButton(7, this.field_146294_l / 2 + 50 + 4, 165, 100, 20, I18n.func_135052_a("advMode.mode.redstoneTriggered", new Object[0])));
