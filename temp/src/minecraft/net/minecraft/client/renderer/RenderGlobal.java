...
public class RenderGlobal implements IWorldEventListener, IResourceManagerReloadListener {
   ...
   private ChunkRenderDispatcher field_174995_M = null;
            ...
            if(!classinheritancemultimap.isEmpty()) {
               for(Entity entity2 : classinheritancemultimap) {
                  ...
                  if(flag) {
                     ...
                     if((entity2 != this.field_72777_q.func_175606_aa() || this.field_72777_q.field_71474_y.field_74320_O != 0 || flag1) && (entity2.field_70163_u < 0.0D || entity2.field_70163_u >= 256.0D || this.field_72769_h.func_175667_e(new BlockPos(entity2)))) {
                        ++this.field_72749_I;
   ...
   public void func_174970_a(Entity p_174970_1_, double p_174970_2_, ICamera p_174970_4_, int p_174970_5_, boolean p_174970_6_) {
      ...
      if(!flag && this.field_147595_R) {
         ...
         while(!((Queue)queue).isEmpty()) {
            ...
            BlockPos blockpos3 = renderchunk3.func_178568_j();
   ...
   public void func_72731_b(EntityPlayer p_72731_1_, RayTraceResult p_72731_2_, int p_72731_3_, float p_72731_4_) {
      if(p_72731_3_ == 0 && p_72731_2_.field_72313_a == RayTraceResult.Type.BLOCK) {
         ...
         if(iblockstate.func_185904_a() != Material.field_151579_a && this.field_72769_h.func_175723_af().func_177746_a(blockpos)) {
            ...
            func_181561_a(iblockstate.func_185918_c(this.field_72769_h, blockpos).func_186662_g(0.0020000000949949026D).func_72317_d(-d0, -d1, -d2));
         }
   ...
   public void func_180439_a(EntityPlayer p_180439_1_, int p_180439_2_, BlockPos p_180439_3_, int p_180439_4_) {
      ...
      case 2002:
         ...
         for(int i2 = 0; i2 < 100; ++i2) {
            ...
            EntityFX entityfx1 = this.func_174974_b(enumparticletypes.func_179348_c(), enumparticletypes.func_179344_e(), d6 + d22 * 0.1D, d7 + 0.3D, d9 + d26 * 0.1D, d22, d24, d26, new int[0]);
            if(entityfx1 != null) {
               float f5 = 0.75F + random.nextFloat() * 0.25F;
               entityfx1.func_70538_b(f * f5, f1 * f5, f2 * f5);
               entityfx1.func_70543_e((float)d16);
            }
         }
      ...
      case 2006:
         for(int l = 0; l < 200; ++l) {
            ...
            EntityFX entityfx = this.func_174974_b(EnumParticleTypes.DRAGON_BREATH.func_179348_c(), false, (double)p_180439_3_.func_177958_n() + d3 * 0.1D, (double)p_180439_3_.func_177956_o() + 0.3D, (double)p_180439_3_.func_177952_p() + d5 * 0.1D, d3, d4, d5, new int[0]);
            if(entityfx != null) {
               entityfx.func_70543_e(f3);
            }
         }
