...
public class ModelBakery {
   ...
   private ModelBlockDefinition func_188632_a(ResourceLocation p_188632_1_, ResourceLocation p_188632_2_) {
      ...
      try {
         ...
         throw new RuntimeException("Encountered an exception when loading model definition of model " + p_188632_2_.toString(), ioexception);
      }
   ...
   private void func_188634_a(String p_188634_1_, ResourceLocation p_188634_2_, ResourceLocation p_188634_3_) {
      ...
      if(this.field_177611_h.get(p_188634_2_) == null) {
         try {
            ...
            field_177603_c.warn((String)("Unable to load item model: \'" + p_188634_2_ + "\' for item: \'" + p_188634_3_ + "\'"), (Throwable)exception);
         }
   ...
   private void func_177574_i() {
      ...
      while(!((Deque)deque).isEmpty()) {
         ...
         try {
            ...
            field_177603_c.warn((String)("In parent chain: " + field_177601_e.join(this.func_177573_e(resourcelocation1)) + "; unable to load model: \'" + resourcelocation1 + "\'"), (Throwable)exception);
         }
