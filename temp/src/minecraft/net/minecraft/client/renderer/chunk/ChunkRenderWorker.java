   ...
   protected void func_178474_a(final ChunkCompileTaskGenerator p_178474_1_) throws InterruptedException {
      ...
      try {
         ...
         if(blockpos1.func_177982_a(8, 8, 8).func_177951_i(blockpos) > 576.0D) {
            ...
            boolean flag = this.func_188263_a(blockpos$mutableblockpos.func_181079_c(blockpos1.func_177958_n() - 1, blockpos1.func_177956_o(), blockpos1.func_177952_p()), world);
            boolean flag1 = this.func_188263_a(blockpos$mutableblockpos.func_181079_c(blockpos1.func_177958_n(), blockpos1.func_177956_o(), blockpos1.func_177952_p() - 1), world);
            boolean flag2 = this.func_188263_a(blockpos$mutableblockpos.func_181079_c(blockpos1.func_177958_n() + 16, blockpos1.func_177956_o(), blockpos1.func_177952_p()), world);
            boolean flag3 = this.func_188263_a(blockpos$mutableblockpos.func_181079_c(blockpos1.func_177958_n(), blockpos1.func_177956_o(), blockpos1.func_177952_p() + 16), world);
