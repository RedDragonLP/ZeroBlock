   ...
   public void func_177141_a(EntityLivingBase p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_, float p_177141_5_, float p_177141_6_, float p_177141_7_, float p_177141_8_) {
      ...
      if(i > 0) {
         ...
         for(int j = 0; j < i; ++j) {
            ...
            entity.field_70126_B = entity.field_70177_z = (float)(Math.atan2((double)f, (double)f2) * 57.2957763671875D);
            entity.field_70127_C = entity.field_70125_A = (float)(Math.atan2((double)f1, (double)f6) * 57.2957763671875D);
            double d0 = 0.0D;
            double d1 = 0.0D;
            double d2 = 0.0D;
            this.field_177168_a.func_177068_d().func_188391_a(entity, d0, d1, d2, 0.0F, p_177141_4_, false);
