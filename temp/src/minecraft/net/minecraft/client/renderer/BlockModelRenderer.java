...
public class BlockModelRenderer {
   ...
   private void func_187494_a(IBlockState p_187494_1_, int[] p_187494_2_, EnumFacing p_187494_3_, float[] p_187494_4_, BitSet p_187494_5_) {
      float f = 32.0F;
      float f1 = 32.0F;
      float f2 = 32.0F;
      float f3 = -32.0F;
   ...
   private void func_187496_a(IBlockAccess p_187496_1_, IBlockState p_187496_2_, BlockPos p_187496_3_, int p_187496_4_, boolean p_187496_5_, VertexBuffer p_187496_6_, List<BakedQuad> p_187496_7_, BitSet p_187496_8_) {
      ...
      for(int j1 = p_187496_7_.size(); i1 < j1; ++i1) {
         ...
         if(p_187496_5_) {
            ...
            p_187496_4_ = p_187496_8_.get(0)?p_187496_2_.func_185889_a(p_187496_1_, p_187496_3_.func_177972_a(bakedquad.func_178210_d())):p_187496_2_.func_185889_a(p_187496_1_, p_187496_3_);
         }
         ...
         if(bakedquad.func_178212_b()) {
            int l = this.field_187499_a.func_186724_a(p_187496_2_, p_187496_1_, p_187496_3_, bakedquad.func_178211_c());
            if(EntityRenderer.field_78517_a) {
   ...
   class AmbientOcclusionFace {
      ...
      public void func_187491_a(IBlockAccess p_187491_1_, IBlockState p_187491_2_, BlockPos p_187491_3_, EnumFacing p_187491_4_, float[] p_187491_5_, BitSet p_187491_6_) {
         ...
         BlockPos.PooledMutableBlockPos blockpos$pooledmutableblockpos1 = BlockPos.PooledMutableBlockPos.func_185342_g(blockpos).func_185341_c(blockmodelrenderer$enumneighborinfo.field_178276_g[0]);
         BlockPos.PooledMutableBlockPos blockpos$pooledmutableblockpos2 = BlockPos.PooledMutableBlockPos.func_185342_g(blockpos).func_185341_c(blockmodelrenderer$enumneighborinfo.field_178276_g[1]);
         BlockPos.PooledMutableBlockPos blockpos$pooledmutableblockpos3 = BlockPos.PooledMutableBlockPos.func_185342_g(blockpos).func_185341_c(blockmodelrenderer$enumneighborinfo.field_178276_g[2]);
         BlockPos.PooledMutableBlockPos blockpos$pooledmutableblockpos4 = BlockPos.PooledMutableBlockPos.func_185342_g(blockpos).func_185341_c(blockmodelrenderer$enumneighborinfo.field_178276_g[3]);
         ...
         boolean flag = p_187491_1_.func_180495_p(blockpos$pooledmutableblockpos.func_185340_h(blockpos$pooledmutableblockpos1).func_185341_c(p_187491_4_)).func_185895_e();
         boolean flag1 = p_187491_1_.func_180495_p(blockpos$pooledmutableblockpos.func_185340_h(blockpos$pooledmutableblockpos2).func_185341_c(p_187491_4_)).func_185895_e();
         boolean flag2 = p_187491_1_.func_180495_p(blockpos$pooledmutableblockpos.func_185340_h(blockpos$pooledmutableblockpos3).func_185341_c(p_187491_4_)).func_185895_e();
         boolean flag3 = p_187491_1_.func_180495_p(blockpos$pooledmutableblockpos.func_185340_h(blockpos$pooledmutableblockpos4).func_185341_c(p_187491_4_)).func_185895_e();
         float f4;
         int i1;
         if(!flag2 && !flag) {
            f4 = f;
            ...
            BlockPos blockpos1 = blockpos$pooledmutableblockpos.func_185340_h(blockpos$pooledmutableblockpos1).func_185341_c(blockmodelrenderer$enumneighborinfo.field_178276_g[2]);
         ...
         if(!flag3 && !flag) {
            ...
            BlockPos blockpos2 = blockpos$pooledmutableblockpos.func_185340_h(blockpos$pooledmutableblockpos1).func_185341_c(blockmodelrenderer$enumneighborinfo.field_178276_g[3]);
         ...
         if(!flag2 && !flag1) {
            ...
            BlockPos blockpos3 = blockpos$pooledmutableblockpos.func_185340_h(blockpos$pooledmutableblockpos2).func_185341_c(blockmodelrenderer$enumneighborinfo.field_178276_g[2]);
         ...
         if(!flag3 && !flag1) {
            ...
            BlockPos blockpos4 = blockpos$pooledmutableblockpos.func_185340_h(blockpos$pooledmutableblockpos2).func_185341_c(blockmodelrenderer$enumneighborinfo.field_178276_g[3]);
