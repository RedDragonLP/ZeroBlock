...
public class VertexBuffer {
   ...
   private void func_181670_b(int p_181670_1_) {
      int i = (this.field_178997_d + 1) * this.field_179011_q.func_177338_f() + this.field_179011_q.func_181720_d(this.field_181678_g);
      if(p_181670_1_ > this.field_178999_b.remaining() || i >= this.field_179001_a.capacity()) {
         int j = this.field_179001_a.capacity();
         int k = j % 2097152;
         int l = k + (((this.field_178999_b.position() + p_181670_1_) * 4 - k) / 2097152 + 1) * 2097152;
         field_187316_a.debug("Needed to grow BufferBuilder buffer: Old size " + j + " bytes, new size " + l + " bytes.");
         int i1 = this.field_178999_b.position();
         ByteBuffer bytebuffer = GLAllocation.func_74524_c(l);
         ...
         this.field_178999_b = this.field_179001_a.asIntBuffer();
         this.field_178999_b.position(i1);
         this.field_181676_c = this.field_179001_a.asShortBuffer();
         this.field_181676_c.position(i1 << 1);
      }
   }
