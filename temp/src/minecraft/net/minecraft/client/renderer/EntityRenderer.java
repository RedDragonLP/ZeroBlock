...
public class EntityRenderer implements IResourceManagerReloadListener {
   ...
   public void func_78473_a(float p_78473_1_) {
      ...
      if(entity != null) {
         if(this.field_78531_r.field_71441_e != null) {
            ...
            Vec3d vec3d3 = null;
            float f = 1.0F;
            List<Entity> list = this.field_78531_r.field_71441_e.func_175674_a(entity, entity.func_174813_aQ().func_72321_a(vec3d1.field_72450_a * d0, vec3d1.field_72448_b * d0, vec3d1.field_72449_c * d0).func_72314_b((double)f, (double)f, (double)f), Predicates.and(EntitySelectors.field_180132_d, new Predicate<Entity>() {
   ...
   private void func_78484_h() {
      ...
      if(f != 0.0F) {
         ...
         for(int l = 0; l < k; ++l) {
            ...
            if(blockpos1.func_177956_o() <= blockpos.func_177956_o() + i && blockpos1.func_177956_o() >= blockpos.func_177956_o() - i && biome.func_76738_d() && biome.func_180626_a(blockpos1) >= 0.15F) {
   ...
   private void func_78466_h(float p_78466_1_) {
      ...
      if(this.field_78531_r.field_71474_y.field_151451_c >= 4) {
         double d0 = -1.0D;
         Vec3d vec3d2 = MathHelper.func_76126_a(world.func_72929_e(p_78466_1_)) > 0.0F?new Vec3d(d0, 0.0D, 0.0D):new Vec3d(1.0D, 0.0D, 0.0D);
