...
public class RenderHelper {
   ...
   public static void func_74519_b() {
      ...
      float f = 0.6F;
      GlStateManager.func_187438_a(16384, 4609, func_74521_a(f, f, f, 1.0F));
      ...
      GlStateManager.func_187438_a(16385, 4609, func_74521_a(f, f, f, 1.0F));
      ...
      float f1 = 0.4F;
      GlStateManager.func_187424_a(2899, func_74521_a(f1, f1, f1, 1.0F));
   }
