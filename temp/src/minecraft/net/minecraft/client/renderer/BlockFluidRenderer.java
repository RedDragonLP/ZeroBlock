...
public class BlockFluidRenderer {
   ...
   public boolean func_178270_a(IBlockAccess p_178270_1_, IBlockState p_178270_2_, BlockPos p_178270_3_, VertexBuffer p_178270_4_) {
      ...
      if(!flag1 && !flag2 && !aboolean[0] && !aboolean[1] && !aboolean[2] && !aboolean[3]) {
         ...
         if(flag1) {
            flag3 = true;
            float f12 = BlockLiquid.func_185697_a(p_178270_1_, p_178270_3_, material);
         ...
         if(flag2) {
            ...
            int i2 = l1 >> 16 & '\uffff';
            int j2 = l1 & '\uffff';
            p_178270_4_.func_181662_b(d0, d1, d2 + 1.0D).func_181666_a(f3, f3, f3, 1.0F).func_187315_a((double)f35, (double)f38).func_187314_a(i2, j2).func_181675_d();
            p_178270_4_.func_181662_b(d0, d1, d2).func_181666_a(f3, f3, f3, 1.0F).func_187315_a((double)f35, (double)f37).func_187314_a(i2, j2).func_181675_d();
            p_178270_4_.func_181662_b(d0 + 1.0D, d1, d2).func_181666_a(f3, f3, f3, 1.0F).func_187315_a((double)f36, (double)f37).func_187314_a(i2, j2).func_181675_d();
            p_178270_4_.func_181662_b(d0 + 1.0D, d1, d2 + 1.0D).func_181666_a(f3, f3, f3, 1.0F).func_187315_a((double)f36, (double)f38).func_187314_a(i2, j2).func_181675_d();
            flag3 = true;
         }
