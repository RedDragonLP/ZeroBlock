...
public class EntityPlayerSP extends AbstractClientPlayer {
   ...
   public void func_70071_h_() {
      if(this.field_70170_p.func_175667_e(new BlockPos(this.field_70165_t, 0.0D, this.field_70161_v))) {
         ...
         if(this.func_184218_aH()) {
            this.field_71174_a.func_147297_a(new CPacketPlayer.C05PacketPlayerLook(this.field_70177_z, this.field_70125_A, this.field_70122_E));
   ...
   public void func_175161_p() {
      ...
      if(this.func_175160_A()) {
         ...
         if(this.func_184218_aH()) {
            this.field_71174_a.func_147297_a(new CPacketPlayer.C06PacketPlayerPosLook(this.field_70159_w, -999.0D, this.field_70179_y, this.field_70177_z, this.field_70125_A, this.field_70122_E));
            flag2 = false;
         } else if(flag2 && flag3) {
            this.field_71174_a.func_147297_a(new CPacketPlayer.C06PacketPlayerPosLook(this.field_70165_t, axisalignedbb.field_72338_b, this.field_70161_v, this.field_70177_z, this.field_70125_A, this.field_70122_E));
         } else if(flag2) {
            this.field_71174_a.func_147297_a(new CPacketPlayer.C04PacketPlayerPosition(this.field_70165_t, axisalignedbb.field_72338_b, this.field_70161_v, this.field_70122_E));
         } else if(flag3) {
            this.field_71174_a.func_147297_a(new CPacketPlayer.C05PacketPlayerLook(this.field_70177_z, this.field_70125_A, this.field_70122_E));
   ...
   public void func_70636_d() {
      ...
      if(this.field_70122_E && !flag1 && !flag2 && this.field_71158_b.field_78900_b >= f && !this.func_70051_ag() && flag3 && !this.func_184587_cr() && !this.func_70644_a(MobEffects.field_76440_q)) {
      ...
      if(!this.func_70051_ag() && this.field_71158_b.field_78900_b >= f && flag3 && !this.func_184587_cr() && !this.func_70644_a(MobEffects.field_76440_q) && this.field_71159_c.field_71474_y.field_151444_V.func_151470_d()) {
         this.func_70031_b(true);
      }
