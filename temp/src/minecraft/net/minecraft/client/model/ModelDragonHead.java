...
public class ModelDragonHead extends ModelBase {
   ...
   public ModelDragonHead(float p_i46588_1_) {
      ...
      this.field_187070_a.func_78786_a("upperlip", -6.0F, -1.0F, -8.0F + f, 12, 5, 16);
      this.field_187070_a.func_78786_a("upperhead", -8.0F, -8.0F, 6.0F + f, 16, 16, 16);
      this.field_187070_a.field_78809_i = true;
      this.field_187070_a.func_78786_a("scale", -5.0F, -12.0F, 12.0F + f, 2, 4, 6);
      this.field_187070_a.func_78786_a("nostril", -5.0F, -3.0F, -6.0F + f, 2, 2, 4);
      this.field_187070_a.field_78809_i = false;
      this.field_187070_a.func_78786_a("scale", 3.0F, -12.0F, 12.0F + f, 2, 4, 6);
      this.field_187070_a.func_78786_a("nostril", 3.0F, -3.0F, -6.0F + f, 2, 2, 4);
      this.field_187071_b = new ModelRenderer(this, "jaw");
      this.field_187071_b.func_78793_a(0.0F, 4.0F, 8.0F + f);
