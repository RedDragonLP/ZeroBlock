...
public class ModelDragon extends ModelBase {
   ...
   public void func_78088_a(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_) {
      ...
      for(int i = 0; i < 5; ++i) {
         ...
         this.field_78219_b.field_78796_g = this.func_78214_a(adouble1[0] - adouble[0]) * 0.017453292F * f5;
         this.field_78219_b.field_78795_f = f9 + entitydragon.func_184667_a(i, adouble, adouble1) * 0.017453292F * f5 * 5.0F;
         this.field_78219_b.field_78808_h = -this.func_78214_a(adouble1[0] - (double)f7) * 0.017453292F * f5;
      ...
      this.field_78221_a.field_78795_f = this.func_78214_a((double)entitydragon.func_184667_a(6, adouble, adouble2)) * 0.017453292F * f5 * 5.0F;
      ...
      for(int k = 0; k < 12; ++k) {
         ...
         this.field_78219_b.field_78796_g = (this.func_78214_a(adouble2[0] - adouble[0]) * f5 + 180.0F) * 0.017453292F;
         this.field_78219_b.field_78795_f = f10 + (float)(adouble2[1] - adouble[1]) * 0.017453292F * f5 * 5.0F;
         this.field_78219_b.field_78808_h = this.func_78214_a(adouble2[0] - (double)f7) * 0.017453292F * f5;
         this.field_78219_b.field_78797_d = f2;
         this.field_78219_b.field_78798_e = f3;
         this.field_78219_b.field_78800_c = f4;
         f2 = (float)((double)f2 + Math.sin((double)this.field_78219_b.field_78795_f) * 10.0D);
