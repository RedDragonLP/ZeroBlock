   ...
   public void func_73718_a(int p_73718_1_) {
      if(!this.field_73725_b.field_71425_J) {
         ...
         if(i - this.field_73723_d >= 100L) {
            ...
            vertexbuffer.func_181662_b(0.0D, (double)l, 0.0D).func_187315_a(0.0D, (double)((float)l / f)).func_181669_b(64, 64, 64, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)k, (double)l, 0.0D).func_187315_a((double)((float)k / f), (double)((float)l / f)).func_181669_b(64, 64, 64, 255).func_181675_d();
            vertexbuffer.func_181662_b((double)k, 0.0D, 0.0D).func_187315_a((double)((float)k / f), 0.0D).func_181669_b(64, 64, 64, 255).func_181675_d();
