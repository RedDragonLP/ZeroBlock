...
public class EntityEnchantmentTableParticleFX extends EntityFX {
   ...
   protected EntityEnchantmentTableParticleFX(World p_i1204_1_, double p_i1204_2_, double p_i1204_4_, double p_i1204_6_, double p_i1204_8_, double p_i1204_10_, double p_i1204_12_) {
      ...
      this.field_187126_f = this.field_187123_c = p_i1204_2_ + p_i1204_8_;
      this.field_187127_g = this.field_187124_d = p_i1204_4_ + p_i1204_10_;
      this.field_187128_h = this.field_187125_e = p_i1204_6_ + p_i1204_12_;
      float f = this.field_187136_p.nextFloat() * 0.6F + 0.4F;
      this.field_70565_a = this.field_70544_f = this.field_187136_p.nextFloat() * 0.5F + 0.2F;
