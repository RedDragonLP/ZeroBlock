...
public class EntityPortalFX extends EntityFX {
   ...
   protected EntityPortalFX(World p_i46351_1_, double p_i46351_2_, double p_i46351_4_, double p_i46351_6_, double p_i46351_8_, double p_i46351_10_, double p_i46351_12_) {
      ...
      this.field_70574_aq = this.field_187126_f = p_i46351_2_;
      this.field_70573_ar = this.field_187127_g = p_i46351_4_;
      this.field_70572_as = this.field_187128_h = p_i46351_6_;
      float f = this.field_187136_p.nextFloat() * 0.6F + 0.4F;
      this.field_70571_a = this.field_70544_f = this.field_187136_p.nextFloat() * 0.2F + 0.5F;
