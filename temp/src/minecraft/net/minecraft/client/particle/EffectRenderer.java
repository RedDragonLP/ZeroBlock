...
import net.minecraft.client.particle.EntityEndRodFX;
...
import net.minecraft.client.particle.EntitySweepAttackFX;
...
public class EffectRenderer {
   ...
   private final ArrayDeque<EntityFX>[][] field_78876_b = new ArrayDeque[4][];
   private final Queue<EntityParticleEmitter> field_178933_d = Queues.<EntityParticleEmitter>newArrayDeque();
   ...
   private void func_178930_c() {
      ...
      this.func_178929_a(EnumParticleTypes.DRAGON_BREATH.func_179348_c(), new EntityDragonBreathFX.Factory());
      this.func_178929_a(EnumParticleTypes.END_ROD.func_179348_c(), new EntityEndRodFX.Factory());
      this.func_178929_a(EnumParticleTypes.DAMAGE_INDICATOR.func_179348_c(), new EntityCrit2FX.DamageIndicatorFactory());
      this.func_178929_a(EnumParticleTypes.SWEEP_ATTACK.func_179348_c(), new EntitySweepAttackFX.Factory());
   }
      ...
      for(final int i = 0; i < 3; ++i) {
         for(int j = 0; j < 2; ++j) {
            if(!this.field_78876_b[i][j].isEmpty()) {
               ...
               for(final EntityFX entityfx : this.field_78876_b[i][j]) {
                  try {
   ...
   public void func_78872_b(Entity p_78872_1_, float p_78872_2_) {
      ...
      for(int i = 0; i < 2; ++i) {
         Queue<EntityFX> queue = this.field_78876_b[3][i];
         if(!queue.isEmpty()) {
            Tessellator tessellator = Tessellator.func_178181_a();
            VertexBuffer vertexbuffer = tessellator.func_178180_c();
   ...
   public void func_180532_a(BlockPos p_180532_1_, EnumFacing p_180532_2_) {
      ...
      if(iblockstate.func_185901_i() != EnumBlockRenderType.INVISIBLE) {
         ...
         double d0 = (double)i + this.field_78875_d.nextDouble() * (axisalignedbb.field_72336_d - axisalignedbb.field_72340_a - (double)(f * 2.0F)) + (double)f + axisalignedbb.field_72340_a;
         double d1 = (double)j + this.field_78875_d.nextDouble() * (axisalignedbb.field_72337_e - axisalignedbb.field_72338_b - (double)(f * 2.0F)) + (double)f + axisalignedbb.field_72338_b;
         double d2 = (double)k + this.field_78875_d.nextDouble() * (axisalignedbb.field_72334_f - axisalignedbb.field_72339_c - (double)(f * 2.0F)) + (double)f + axisalignedbb.field_72339_c;
