...
public class ItemArmor extends Item {
   ...
   public static ItemStack func_185082_a(IBlockSource p_185082_0_, ItemStack p_185082_1_) {
      BlockPos blockpos = p_185082_0_.func_180699_d().func_177972_a(BlockDispenser.func_149937_b(p_185082_0_.func_82620_h()));
      ...
      List<EntityLivingBase> list = p_185082_0_.func_82618_k().<EntityLivingBase>func_175647_a(EntityLivingBase.class, axisalignedbb, Predicates.<EntityLivingBase>and(EntitySelectors.field_180132_d, new EntitySelectors.ArmoredMob(p_185082_1_)));
      if(list.isEmpty()) {
         return null;
      } else {
   ...
   public static enum ArmorMaterial {
      LEATHER("leather", 5, new int[]{1, 2, 3, 1}, 15, SoundEvents.field_187728_s),
      CHAIN("chainmail", 15, new int[]{1, 4, 5, 2}, 12, SoundEvents.field_187713_n),
      IRON("iron", 15, new int[]{2, 5, 6, 2}, 9, SoundEvents.field_187725_r),
      GOLD("gold", 7, new int[]{1, 3, 5, 2}, 25, SoundEvents.field_187722_q),
      DIAMOND("diamond", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.field_187716_o);
      ...
      private ArmorMaterial(String p_i46796_3_, int p_i46796_4_, int[] p_i46796_5_, int p_i46796_6_, SoundEvent p_i46796_7_) {
         this.field_179243_f = p_i46796_3_;
         this.field_78048_f = p_i46796_4_;
         this.field_78049_g = p_i46796_5_;
         this.field_78055_h = p_i46796_6_;
