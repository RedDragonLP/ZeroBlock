...
import com.RedDragonLP.ZeroBlock_client.gui.alts.GuiAltManager;
...
public class GuiZeroBlockMainMenu extends GuiScreen implements GuiYesNoCallback
{
    private static final AtomicInteger UNIQUE_THREAD_ID = new AtomicInteger(0);
    private static final Logger LOGGER = LogManager.getLogger();
    private static final Random RANDOM = new Random();
    
    /** Scrolling splash message. */
    public static int scroller = 0;
    public static int scrollerSpeed = 1;
    public static String scrollerText = "ZeroBlock is the best Client";
    
    /** Custom splash message. */
    public static String[] splashes = {"RedDragonLP", "ZeroBlock is the best Client", "I'm not a Hacker, I'm just good", "Thanks for the support"};
    public static int randSplash = RANDOM.nextInt(splashes.length);
    ...
    public void initGui()
    {
        ...
        {
            this.splashes = new String[] {"Merry X-mas!"};
            this.randSplash = 0;
        }
        else if (calendar.get(2) + 1 == 1 && calendar.get(5) == 1)
        {
            this.splashes = new String[] {"Happy new year!"};
            this.randSplash = 0;
        }
        else if (calendar.get(2) + 1 == 10 && calendar.get(5) == 31)
        {
            this.splashes = new String[] {"OOoooOOOoooo! Spooky!"};
            this.randSplash = 0;
        }
        else if (calendar.get(2) + 1 == 7 && calendar.get(5) == 19)
        {
        	this.splashes = new String[] {"Happy Birthday RedDragonLP"};
        	this.randSplash = 0;
        }
        int i = 24;
        ...
        this.buttonList.add(new CustomButton(0, this.width / 2 - 101, j + 44, 100, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new CustomButton(4, this.width / 2 + 1, j + 44, 100, 20, I18n.format("menu.quit", new Object[0])));
        ...
        synchronized (this.threadLock)
        {
            ...
            this.openGLWarningY1 = ((CustomButton)this.buttonList.get(0)).yPosition - 24;
    ...
    {
        this.buttonList.add(new CustomButton(1, this.width / 2 - 101, p_73969_1_, 100, 20, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new CustomButton(2, this.width / 2 + 1, p_73969_1_, 100, 20, I18n.format("menu.multiplayer", new Object[0])));
        this.realmsButton = this.func_189646_b(new CustomButton(14, this.width / 2 - 101, p_73969_1_ + p_73969_2_ - 2, 100, 20, I18n.format("menu.online", new Object[0])));
        this.buttonList.add(new CustomButton(100, this.width / 2 + 1, p_73969_1_ + p_73969_2_ - 2, 100, 20, "Alt Manager"));
    }
    ...
    {
        this.buttonList.add(new CustomButton(11, this.width / 2 - 100, p_73972_1_, I18n.format("menu.playdemo", new Object[0])));
        this.buttonResetDemo = this.func_189646_b(new CustomButton(12, this.width / 2 - 100, p_73972_1_ + p_73972_2_ * 1, I18n.format("menu.resetdemo", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.renderBackground(new ScaledResolution(this.mc));
...
//        f = f * 100.0F / (float)(this.fontRendererObj.getStringWidth(splashes[randSplash]) + 32);
//        GlStateManager.scale(f, f, f);
//        this.drawCenteredString(this.fontRendererObj, splashes[randSplash], 0, -8, -256);
//        GlStateManager.popMatrix();
        String s = ZeroBlock.FULL_VERSION;
        ...
        if (scroller >= this.width - this.fontRendererObj.getStringWidth(scrollerText))
        {
        	this.scroller = 0 + this.fontRendererObj.getStringWidth(scrollerText);

        }
        else
        {
        	this.scroller -= scrollerSpeed;
        }
        fontRendererObj.drawStringWithShadow(scrollerText, scroller, this.height - 20, 0xFFFFF);
    ...
    private void renderBackground(ScaledResolution scaledRes)
    {
        ...
        this.mc.getTextureManager().bindTexture(ZeroBlock.INSTANCE.LOCATION_MAIN_BACKGROUND);
