...
import com.RedDragonLP.ZeroBlock_client.hooks.GuiIngameHook;
...
public class Minecraft implements IThreadListener, ISnooperInfo
{
	...
	private void startGame() throws LWJGLException, IOException
	{
		...
		// TODO:ZeroBlock
		ZeroBlock.INSTANCE.startClient();

		if (this.serverName != null)
		{
			this.displayGuiScreen(
					new GuiConnecting(new GuiZeroBlockMainMenu(), this, this.serverName, this.serverPort));
		} else
		{
			this.displayGuiScreen(new GuiZeroBlockMainMenu());
		}
	...
	private void createDisplay() throws LWJGLException
	{
		...
		// TODO:ZeroBlock
		Display.setTitle(ZeroBlock.FULL_VERSION);
	...
	private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException
	{
		...
		try
		{
			inputstream = this.mcDefaultResourcePack.getInputStream(ZeroBlock.INSTANCE.LOCATION_LOADING_SCREEN);
		...
		{
			LOGGER.error("Unable to load logo: {}",
					new Object[] { ZeroBlock.INSTANCE.LOCATION_LOADING_SCREEN, ioexception });
		} finally
		{
			IOUtils.closeQuietly(inputstream);
		}
	...
	public void displayGuiScreen(@Nullable GuiScreen guiScreenIn)
	{
		...
		{
			guiScreenIn = new GuiZeroBlockMainMenu();
		} else if (guiScreenIn == null && this.thePlayer.getHealth() <= 0.0F)
		{
			guiScreenIn = new GuiGameOver((ITextComponent) null);
		}

		if (guiScreenIn instanceof GuiZeroBlockMainMenu || guiScreenIn instanceof GuiMultiplayer)
		{
